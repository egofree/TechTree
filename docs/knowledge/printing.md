...
**Type casting**: Brass matrix (mold) for each character. Inject molten type metal into matrix with hand casting ladle or simple plunger mold. Each type piece is a rectangular block ~2 cm tall with raised letter on one face. Cast hundreds of each letter. Organize in type cases (wooden trays with compartments — larger compartments for common letters: e, t, a, o, i, n, s).
...
**Carbon ink** (printing ink base): Soot (lampblack from burning oil or resin) + linseed oil binder + rosin (improves tack and drying). Grind soot with oil on stone slab with muller (flat glass or stone disk) until uniform smooth paste. Consistency: thick enough to adhere to type face without running, thin enough for even transfer.

**Iron gall ink** (archival writing): Dissolve 40 g iron sulfate (FeSO₄·7H₂O) in 200 mL water. Separately, extract tannic acid by soaking 30 g crushed oak galls in 200 mL warm water for 24 hours. Mix solutions. Add 20 g gum arabic (binder). Ink starts pale gray, darkens to deep black as iron-tannate complex oxidizes over 1-2 days. Permanent on parchment and paper — chemically bonds to cellulose.
