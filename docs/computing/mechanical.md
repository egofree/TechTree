...
**[Difference Engine](../glossary/difference-engine.md)** (Babbage-type):
...
**[Babbage Analytical Engine](../glossary/babbage-analytical-engine.md)** (conceptual, requires advanced Machine Tools):
...
**[Mechanical integrators](../glossary/mechanical-integrators.md)** (analog computing):
...
**[Curta calculator](../glossary/curta-calculator.md)** (handheld stepped drum):
...
**[Keyboard-driven calculators](../glossary/keyboard-driven-calculators.md)** (late mechanical era, 1900-1960):
...
1. **[Abacus and counting board](../glossary/abacus-and-counting-board.md)** (ancient to present): Requires zero manufacturing infrastructure. Wood, beads, and cord. Remains competitive for certain calculations well into the electronic age.
2. **[Napier's bones and sector](../glossary/napiers-bones-and-sector.md)** (~1600): Requires only basic woodworking or metalworking. Individual rods can be made by hand with simple tools.
3. **[Gear-based adders](../glossary/gear-based-adders.md)** (~1640-1820): Requires precision brass casting and gear cutting. Pascal and Leibniz machines demanded manufacturing tolerances unavailable in their era, which limited production.
4. **[Difference Engine](../glossary/difference-engine.md)** (~1820-1850): Requires machine tools capable of ±0.025 mm tolerances on thousands of parts. Babbage's engine was not completed in his lifetime partly because manufacturing technology had not yet caught up with his designs.
...
- **[Babbage's Design No. 2](../glossary/babbages-design-no-2.md)** (1847-1849, never built in his lifetime): 7th-order polynomial evaluator with 31-digit numbers. Estimated 25,000 parts, total weight approximately 15 tons. The Science Museum London built it from Babbage's plans in 1991: it works perfectly, vindicating his design after 150 years.
...
- **Pinch and crush injuries**: Mechanical calculators contain interlocking gears, spring-loaded carry levers, and sliding carriages that move with significant force. The carry mechanism in an Arithmometer or Difference Engine snaps from 9 to 0 under spring tension — fingers caught between meshing gears or under a shifting carriage will be crushed or amputated. Never reach into the mechanism while the crank is engaged. Disengage the crank or remove the handle before adjusting or clearing. Train operators to keep fingers clear of the carriage rails during multiplication cycles (the carriage shifts left automatically between digit positions).
- **Metal dust and chips during manufacturing**: Gear hobbing, milling, and filing produce fine brass and steel particles. Brass dust is a respiratory irritant; steel chips are an eye penetration hazard. Wear eye protection when cutting gears on the lathe or milling machine. Use a chip guard on the dividing head. Collect filings regularly — accumulated brass dust on the shop floor is a slip hazard and a fire hazard (brass filings can ignite under extreme conditions). Wash hands before eating after machining brass or leaded alloys.
- **Lead exposure**: Free-machining brass (used for gear wheels and digit drums) contains 2-4% lead for improved machinability. Filing and turning this alloy produces lead-containing dust. Avoid sanding or dry-filing without ventilation. Wet grinding is preferred. Do not eat, drink, or smoke in the machining area. Phosphor bronze bearings may also contain trace lead. Handle with the same precautions as leaded brass.
- **Repetitive strain**: Operating a stepped-drum calculator requires hundreds of crank turns per day in accounting and tabulating work. The crank handle is typically metal with a 3-4 cm grip diameter. Sustained cranking causes inflammation of the wrist tendons (tenosynovitis) and elbow (epicondylitis). The Friden and Marchant automatic machines (electric motor drive) largely eliminated this hazard, but hand-crank machines require regular breaks — limit continuous cranking to 30-minute sessions with 10-minute rest periods. Adjust crank handle height to elbow level when seated.
- **Lubricant hazards**: Light machine oil (viscosity 10-30 cSt) used on bearings and gear trains is a slip hazard if spilled on the floor. Some lubricants cause contact dermatitis with prolonged skin contact. Apply oil sparingly with a precision oiler, not by pouring. Wipe excess immediately. Used oil and cleaning solvent (mineral spirits or naphtha used to flush old oil from mechanisms) should be stored in sealed metal containers away from ignition sources. Dispose of oily rags in a closed metal bin — spontaneous combustion is a real risk with oil-soaked cotton or wool rags.
