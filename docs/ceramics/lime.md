...
- **Acid test**: Drop dilute acid (vinegar or HCl) on the rock. Limestone effervesces (fizzes) vigorously as CO₂ bubbles off. This is the definitive field test.
...
- **Calcium carbonate content**: >90% CaCO₃ for high-quality quicklime. Lower purity requires more fuel per tonne of usable lime and produces more ash/slag.
- **Magnesium content**: 0-5% MgCO₃ for high-calcium lime; 20-40% for dolomitic lime. Both are useful but serve different applications.
- **Clay content**: 5-20% clay is desirable for hydraulic lime. >20% clay makes the stone unsuitable for pure lime production (but usable for natural cement).
...
- **Construction**: Cylindrical or bottle-shaped shaft, 1-2 m tall, 0.5-1 m internal diameter at the firing zone. Walls 20-30 cm thick from stacked stone or firebrick. Open top for loading, draw arch at base for lime removal and air intake.
- **Loading**: Alternate layers of crushed limestone (10-20 cm pieces) and fuel (wood or charcoal). Kindling at the bottom. Fill shaft to top.
- **Firing**: Ignite from the base. Maintain moderate draft — too much air cools the kiln, too little smothers the fire. Burn 12-24 hours.
...
- **Construction**: Vertical shaft 3-6 m tall, 1-2 m diameter at the firing zone. Built from firebrick with iron banding for structural support. Three zones: preheating zone (top), calcining zone (middle, hottest), cooling zone (bottom).
...
- **Overburned**: Sintered, hard, dense. Slakes very slowly (hours to days), produces coarse particles. Common cause: excessive temperature (>1200°C) or long soak time. Still chemically usable but produces inferior mortar.
- **Purity test**: Slake a weighed sample, dissolve in excess HCl. Insoluble residue = impurities. <5% residue for high-calcium quicklime.

## The Lime Cycle

The fundamental reversible cycle underlying all lime-based materials:

**[CaCO₃](../glossary/caco.md)** (limestone) → **[heat 900°C]** → **[CaO](../glossary/cao.md)** (quicklime) + CO₂ → **[add water]** → **[Ca(OH)₂](../glossary/caoh.md)** (slaked lime) → **[exposure to air, CO₂]** → **[CaCO₃](../glossary/caco.md)** (re-hardened limestone)
...
- Practical consequence: lime structures continue to harden for years, becoming stronger over time. Roman lime concrete structures are still hardening 2000 years later.

## Hydraulic Lime

Limestone containing 5-20% clay (aluminosilicate) impurities produces hydraulic lime when fired at 1000-1100°C. The clay reacts with lime to form calcium silicates and aluminates (belite, C₂S, and others), which set by hydraulic reaction (with water) rather than by CO₂ absorption alone.

**Classification by clay content**:

| Type | Clay Content | Setting Time | Use |
|------|-------------|-------------|-----|
| Feebly hydraulic | 5-10% | 2-3 weeks | General masonry, above-grade walls |
| Moderately hydraulic | 10-15% | 1-2 weeks | Foundations, moderate exposure |
| Eminently hydraulic | 20-25% | 2-4 hours | Bridges, harbor walls, underwater work |

**Why hydraulic lime matters**: Sets underwater. Essential for hydraulic structures (canals, harbor walls, foundations in wet ground, cisterns). Ordinary (non-hydraulic) lime mortar never hardens if kept continuously wet because CO₂ cannot penetrate to carbonation sites. Hydraulic lime sets by internal chemical reaction with water — no CO₂ needed.
...
- **Weathering**: Lime render erodes slowly in rain (1-2 mm per century). Re-limewash every 3-5 years to maintain protection. This is not a bug — it means the render is sacrificial, protecting the masonry beneath.

## Limewash (Whitewash)

- **Preparation**: Dilute slaked lime with water to paint consistency (roughly 1 part lime putty to 3-5 parts water by volume). Stir thoroughly. Let stand 24 hours if possible (improves consistency).
- **Application**: Apply in 3-5 thin coats, brushing each vigorously into the previous while still damp. Limewash penetrates the surface — it does not form a thick film like paint.
- **Properties**: Disinfecting (alkaline pH kills bacteria and mold). Bright white, reflective (reduces solar heat gain on buildings). Vapor-permeable. Inexpensive. Bonds chemically to lime plaster, masonry, and stone.
- **Color**: Add pigment for colored wash. Iron oxide for red/pink, charcoal for gray, copper sulfate for blue-green, ochre for yellow. Pigment should be lime-proof (alkali-stable).
- **Uses**: Interior walls, exterior masonry, tree trunks (insect barrier and sun-scald prevention), animal pens (disinfectant), fences, cellars.
...
| Stage | Contribution |
|-------|-------------|
| Foundations | Lime mortar for stone and brick construction; whitewash for hygiene and visibility |
| Agriculture | Soil pH amendment; calcium nutrient supply |
| Metals | Flux for iron and steel smelting; dolomitic refractory linings |
| Glass | Limestone is a primary raw material for soda-lime glass (~12-15% CaO) |
| Chemistry | Alkali source (causticizing); pH control; precipitant |
| Energy | Flue gas desulfurization (CaO + SO₂ → CaSO₃); boiler water treatment |
| Textiles | Tanning and hide processing; scouring of raw wool |
| Health | Water purification; sewage disinfection; sanitary limewash |
...
- **[Iron & Steel](../glossary/iron-steel.md)** (flux and refractory): [iron-steel.md](../metals/iron-steel.md)
