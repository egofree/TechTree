...
capital cost. Phase 5 achievable.
**Spray-up.** Chopped fiber + catalyzed resin sprayed from gun onto open mold.
Faster but lower fiber content. Phase 5 achievable.
**Vacuum bagging.** Part covered with bagging film, evacuated with vacuum pump.
Consolidates laminate, removes air, improves fiber-to-resin ratio. Phase 6.
...
process control. Well beyond Phase 5–6.
...
## Aramid Fiber / Kevlar (Phase 7+ Aspiration)
...
Well beyond Phase 5–6 chemical capabilities.
...
1. **Phase 5**: E-glass production (furnace + platinum bushings). Hand layup
   and spray-up with polyester resin. Basic fiberglass tanks, panels,
   enclosures.
2. **Phase 5–6**: S-glass production. Epoxy and vinyl ester resins. Vacuum
   bagging for improved laminate quality.
3. **Phase 6**: Filament winding for cylinders. RTM for repeatability.
   Pultrusion for profiles.
4. **Phase 7+**: Carbon fiber (PAN or pitch route). Aramid/Kevlar. Compression
