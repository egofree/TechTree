...
Process-level reference for thermosetting polymers in the tech tree. Thermosets cross-link irreversibly during cure; they cannot be remelted or reformed. This makes them dimensionally stable, heat-resistant, and chemically durable. Feedstocks come from [SQ 12](../side-quests/sq-12-petrochemicals.md).
...
- Note: novolac resins are also the basis for positive-tone photoresist binders in [Phase 8](../core-tech-tree/phase-08-photolithography.md)
...
Applications: die attach adhesive ([SQ 06](../side-quests/sq-06-gases-packaging-testing.md)), IC encapsulation, composite matrix resin, structural adhesive, PCB substrate bonding, protective coatings.
...
Applications: **PCB substrates** (critical dependency for [Phase 8](../core-tech-tree/phase-08-photolithography.md) semiconductor path), electrical panels, terminal boards, brake linings, bearing retainers, structural insulating panels.
...
- [ ] **Phase 5**: Bakelite compression molding operational (electrical insulators, molded fittings)
- [ ] **Phase 5**: Phenolic resin synthesis (novolac and resole routes)
- [ ] **Phase 5**: Urea-formaldehyde molding compounds for housings and fixtures
- [ ] **Phase 5/6**: Unsaturated polyester + fiberglass hand layup (panels, tanks, enclosures)
- [ ] **Phase 6**: Epoxy resin formulation for structural adhesives and composite matrix
- [ ] **Phase 6**: G-10 epoxy-glass laminate production (electrical insulation panels)
- [ ] **Phase 6**: Polyurethane flexible and rigid foam production
- [ ] **Phase 7**: FR-4 brominated epoxy-glass laminate for PCB substrates
- [ ] **Phase 7**: Polyurea spray coating capability
- [ ] **Phase 8**: Novolac-based photoresist resin for photolithography (same chemistry as Bakelite novolac route)
- [ ] **Phase 8**: Epoxy die attach and IC encapsulation materials qualified for fab use
