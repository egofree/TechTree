...
The process chains five distinct stages: mulberry cultivation (the sole food source), silkworm rearing through five larval instars, cocoon harvesting and pupal stifling, silk reeling from boiled cocoons, and degumming to produce finished silk thread. Each stage has tight environmental tolerances. Temperature deviations of more than 3-4°C slow larval growth or increase mortality. Humidity outside the 70-80% range promotes fungal disease or desiccation. The labor intensity peaks during the 25-30 day rearing cycle, when fresh mulberry leaves must be delivered 3-4 times daily and trays cleaned of frass and shed skins.

Silk production originated in China before 3000 BCE and remained a closely guarded monopoly for nearly three millennia. The basic technology requires no metal tools, no complex machinery, and no chemical processing beyond hot water. What it demands is disciplined timing, clean conditions, and a reliable supply of mulberry leaves. A household operation running 2-3 rearing cycles per year can produce 10-20 kg of raw silk from a modest mulberry plot.
...
Harvest by stripping leaves from branches or by cutting whole branches and stripping them in a shaded area. Leaves must be used fresh, ideally within 4-6 hours of picking. Wilted leaves reduce feeding rates and larval growth. Do not pick wet leaves after rain; excess moisture promotes bacterial growth in rearing trays.
...
The lifecycle from egg to moth runs approximately 45-60 days:

| Stage | Duration | Key Events |
|-------|----------|------------|
| Egg (incubation) | 10-12 days | Held at 22-25°C, 75-80% humidity. Eggs darken as the embryo develops. "Chilling" at 4-5°C for up to 10 days can delay hatching to synchronize with leaf availability. |
| 1st instar | 3-4 days | Larvae are 2-3 mm at hatch. Feed on tender, finely chopped young leaves. Mouthparts are small; leaf size matters. |
| 2nd instar | 3-4 days | First molt. Larvae double in size. Continue feeding on young leaves. |
| 3rd instar | 3-4 days | Second molt. Feed on whole leaves. Frass production increases noticeably. |
| 4th instar | 4-5 days | Third molt. Larvae are 3-4 cm long. Feed voraciously. |
| 5th instar | 6-8 days | Fourth molt. Final feeding stage. Larvae consume 80% of their total leaf intake during this instar, growing to 6-8 cm and 4-5 g. Body turns slightly translucent as silk glands fill. Feeding slows and larvae begin wandering, seeking a place to spin. |
| Spinning | 3-4 days | Larva secretes silk filament through the spinneret, constructing an oval cocoon around itself. The filament is a double strand of fibroin glued together with sericin. |
...
- **1st through 3rd instar**: 24-26°C, 75-80% relative humidity. Young larvae are sensitive to cold and drying.
- **4th instar**: 23-25°C, 70-75% humidity.
- **5th instar**: 22-24°C, 65-75% humidity. Slightly cooler and drier conditions prevent disease in the dense final-stage colonies.

Ventilation must provide fresh air without drafts. Carbon dioxide from larval respiration builds up quickly in enclosed spaces; exchange with fresh air every 2-3 hours prevents lethargy and increased mortality. In warm weather, open windows on opposite walls. In cold weather, indirect heating with a clay stove or heated stones, placed where they cannot contact trays or leaves.
...
One box of silkworm eggs contains approximately 20,000 larvae and requires 500-600 kg of fresh mulberry leaves over the full rearing cycle. Of that total, roughly 400-480 kg is consumed during the 5th instar alone. Leaf supply planning is not optional. Running short during the final feeding stage means stunted cocoons and low silk yield.
...
**Cleaning**: Remove frass, shed skins, and dead or diseased larvae daily. Transfer larvae to a clean tray by placing fresh leaves on top of the colony and letting the larvae crawl onto them, then moving the leaves to the clean tray. Handle larvae as little as possible. Physical injury causes infection.
...
- **[Grasserie](../glossary/grasserie.md)** (nuclear polyhedrosis): Viral infection causing larvae to become swollen, glossy, and lethargic. Spreads through frass and body fluids. No treatment. Destroy infected larvae and disinfect trays.
- **[Muscardine](../glossary/muscardine.md)** (fungal): White or green fungus growing on and mummifying larvae. Caused by excessive humidity. Remove infected individuals. Reduce moisture. Disinfect trays with 2% formaldehyde solution or slaked lime wash between rearing cycles.
...
- **Sun drying**: Spread cocoons in thin layers on mats in direct sun for 2-3 days. Ambient temperature must reach 40-50°C for effective kill. Simple but weather-dependent and slow.
- **Steam**: Expose cocoons to steam at 100°C for 5-10 minutes. Kills pupae quickly and uniformly. Requires a steaming rack over a boiling pot. Most common traditional method in established silk regions.
- **Hot air**: Dry cocoons in a heated chamber at 60-70°C for 6-8 hours. Even heating, good for large batches. Requires a purpose-built oven or drying room.
...
- 4-6 kg raw silk after reeling (silk content is 12-20% of fresh cocoon weight)
- 2-3 kg of waste material (pupal remains, outer floss, rejected cocoons)

Pupal remains are high-protein animal feed. In silk-producing regions, they are fed to poultry and fish. Nothing from the cocoon goes to waste.
...
A single filament is too fine for practical use. Reel 5-10 cocoon filaments together to form a single thread of 75-250 μm diameter. The filaments are crossed and slightly twisted as they combine, and the residual sericin gums them together as the thread dries.

**Reeling equipment**: A hand-turned reel consisting of a wheel 0.5-1.0 m in diameter, a traversing guide that spreads the thread evenly across the reel width, and a cocoon basin (pot of hot water where cocoons float as their filaments are drawn off). Reeling speed: 100-200 m/min. One skilled worker reels 500-800 g of raw silk per day, processing roughly 2,000-3,000 cocoons.
...
Silk's material properties make it unique among natural fibers:

| Property | Value | Notes |
|----------|-------|-------|
| Tensile strength | 300-500 MPa | Stronger than steel by weight |
| Density | 1.3 g/cm³ | Lighter than cotton (1.5) or wool (1.3) |
| Moisture absorption | 11% | Comfortable against skin, absorbs sweat |
| Elongation at break | 15-25% | Elastic enough for weaving without breaking |
| Decomposition temperature | ~170°C | Cannot be heat-set like synthetics |
| Filament diameter | 15-25 μm (single), 75-250 μm (reeled thread) | Finest natural textile fiber |
...
- **Mold in rearing rooms**: High humidity (70-80%) maintained over weeks creates ideal mold conditions on trays, walls, and floors. Aspergillus and other molds cause respiratory disease. Clean and disinfect the rearing room between cycles. Replace moldy trays. Ensure ventilation actually exchanges air, not just circulating it.
