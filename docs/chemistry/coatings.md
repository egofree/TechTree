...
**[Binders (resins)](../glossary/binders-resins.html)** — form the continuous film that adheres to substrate and encapsulates pigment:
- **[Linseed oil](../glossary/linseed-oil.html)** (flax seed): Traditional drying oil — polymerizes by oxidation (cross-linking of unsaturated fatty acid chains catalyzed by air). Still used in artists' paints and wood finishes. Drying time: 2-7 days. Added metallic driers (cobalt, manganese naphthenates) accelerate oxidation to 4-12 hours.
...
**[Pigments](../glossary/pigments.html)** — provide color, opacity, and corrosion inhibition:
...
**[Architectural latex paint](../glossary/architectural-latex-paint.html)** (typical interior wall paint): Water 35%, TiO₂ 20%, calcium carbonate (extender) 15%, acrylic emulsion (binder, 50% solids) 25%, additives 5%. PVC (pigment volume concentration) = 55-70% — above CPVC (critical PVC, ~55%) the film is porous (matte finish). Below CPVC: glossy, washable. Additives: dispersant (polyacrylate — prevents pigment flocculation), defoamer (mineral oil + silica — prevents foam during manufacturing and application), thickener (HEUR associative thickener or HEC cellulose ether — controls viscosity and brushability), biocide (isothiazolinone blend — in-can preservation), coalescent (Texanol — helps polymer particles fuse into film, especially at low temperatures).

**[Industrial epoxy coating](../glossary/industrial-epoxy-coating.html)** (two-component): Part A (resin): epoxy resin 60%, TiO₂ 15%, barium sulfate (extender) 10%, xylene/butanol solvent 15%. Part B (hardener): polyamide curing agent 70%, xylene solvent 30%. Mix ratio A:B typically 4:1 by volume. Pot life after mixing: 4-8 hours. Cure: touch dry 4-8 hours, full cure 7 days. Dry film thickness: 75-200 µm per coat.

**[Alkyd enamel](../glossary/alkyd-enamel.html)** (traditional gloss paint): Alkyd resin (70% solids in mineral spirits) 65%, TiO₂ 25%, driers (Co/Mn/Zr naphthenates) 1%, mineral spirits 9%. Dry film thickness: 30-50 µm. Drying: touch dry 4-6 hours, hard dry 12-18 hours.
