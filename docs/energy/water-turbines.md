...
|---------|---------------|----------|
| Pelton bucket splitter ridge eroding, efficiency dropping below 80% | Suspended sediment (sand, silt) in high-velocity jet (44 m/s at 100 m head, 140 m/s at 1000 m head) abrading the knife-edge splitter ridge and bucket surfaces | Install settling basin or desilting chamber upstream of penstock intake. Inspect buckets monthly — re-machine or replace when splitter ridge rounding exceeds 2 mm. Consider stainless steel overlay weld on bucket contact surfaces for sediment-laden streams. Target efficiency recovery to 85–91% after repair |
| Francis turbine efficiency dropping below 80% at design flow | Runner blade profile damaged by cavitation pitting; pits act as nucleation sites for further bubble formation, accelerating damage. Also possible: wicket gate linkage misaligned, causing non-uniform flow angle | Inspect runner blades with the unit dewatered; grind smooth any pits <5 mm deep and polish to original profile (±1 mm tolerance). For deeper pitting, weld-repair with stainless steel and re-profile. Check wicket gate synchronization — all 12–24 vanes should open in unison; adjust linkage rods if any vane is >2° out of phase with others |
| Kaplan blade pitch mechanism seized inside submerged hub | Silt or corrosion in the oil-filled hub has jammed the trunnion bearings; oil seal failure allowed river water ingress, contaminating the hydraulic pitch linkage | Drain hub oil and inspect for water contamination (milky oil). Flush hub with clean oil. Replace rotary shaft seals on the blade trunnions. Refill with specified hydraulic oil. Test blade movement through full 15–40° range before re-energizing. Consider adding moisture sensor in hub oil for early detection |
| Water hammer rupturing penstock at turbine shutoff | Rapid wicket gate or valve closure on a long penstock creates pressure spike of ΔP = ρ × c × Δv = 1000 × 1400 × 3 = 4.2 MPa (42 bar) for a 3 m/s flow velocity stop | Never close turbine valves faster than the critical time T = 2L/c (where L = penstock length, c = 1400 m/s). Install surge tank (standpipe) near the powerhouse to absorb pressure transients. Ensure jet deflectors on Pelton wheels are the primary rapid-shutdown device, not the nozzle needle. Check penstock anchor blocks for movement after any water hammer event |
| Turbine runaway speed reached (1.8–2.5× rated) after load rejection | Generator disconnected from grid and governor/wicket gates failed to close; centrifugal forces scale with speed squared — a 2× overspeed quadruples stress on runner and blades | Immediately close the upstream emergency gate (guaranteed closure independent of governor). After shutdown, inspect runner for elongated blade roots, cracked welds, or bearing damage from overspeed. Test governor servomotor and wicket gate linkage for binding. Install independent overspeed trip that directly trips the emergency gate at 1.2× rated speed |
| Draft tube flow separation causing vibration and power loss | Draft tube cone half-angle exceeding 4–8° design, or runner exit swirl creating a vortex rope (pressure pulsation at 0.2–0.4× runner RPM) that resonates with the structure | Verify draft tube geometry matches design — flare from runner exit to 2–3× diameter at tailwater. If vortex rope is suspected, install air admission valve at the runner cone centerline to inject compressed air and break the vortex. Measure vibration frequency: if it matches draft tube swirl frequency, confirm the diagnosis. Redesign draft tube cone angle to ≤8° half-angle |
| Pelton jet deflector not responding during load rejection | Deflector hinge corroded or actuator linkage bent; jet continues to strike buckets at full power (~44 m/s at 100 m head) when generator has disconnected | Disassemble and inspect deflector hinge mechanism; lubricate or replace corroded pins. Test deflector response time — must swing into jet path within 1–2 seconds of trip signal. Verify deflector actuator hydraulic pressure is within spec. Never operate a Pelton turbine without a functional jet deflector; it is the primary overspeed protection device |
| Generator bearing temperature exceeding 60°C with grease lubrication | Bearing misalignment (shaft not level within 0.05 mm/m), or over-greasing causing churning heat; bearing clearance reduced from thermal expansion at high RPM (200–1000 RPM) | Check shaft alignment with dial indicators at coupling — correct any offset >0.05 mm. Purge excess grease from bearing housing; re-grease with calculated fill quantity (typically 30–50% of free space). Verify bearing clearances match spec for operating temperature. If bearings run >60°C continuously, switch to oil bath lubrication with external cooler |
| Turbine output falling 15–20% during winter months | Trash rack icing or frazil ice formation blocking intake; reduced effective flow area with unchanged head reduces power output per P = η × ρ × g × Q × H | Install compressed air or steam bubblers at trash rack to prevent ice adhesion. Mechanical rack raking system to clear debris and ice. Consider heated intake if frazil ice is chronic (subcooled water forms ice crystals that adhere to metal surfaces). Verify the flow reduction is not from seasonal low flow — compare against stream gauge data |
| Francis wicket gate seals leaking (water bypassing closed gates) | Erosion or corrosion of the bronze or stainless steel guide vane sealing surfaces; high-velocity water leaking through gaps at 3–300 m head, preventing turbine shutdown | Dewater the unit and inspect all wicket gate sealing surfaces. Machine or replace worn seal strips (target seal gap <0.5 mm when gates are closed). Check that all vane pins rotate freely — a stuck vane cannot contribute to a uniform seal. If leakage prevents dewatering for maintenance, use the upstream emergency gate to isolate the unit |
