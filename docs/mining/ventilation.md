...
> **Domain**: [Mining](./)
> **Dependencies**: `mining.drilling`, `energy.steam-power`
...
**Centrifugal fan** (industrial workhorse):
...
**Forcing system** (fan on intake side):
...
**Exhausting system** (fan on return side):
...
**Auxiliary ventilation** (local supply to dead-end headings):
...
**Flame safety lamp** (Davy lamp and descendants):
...
**Water suppression** (primary defense, most effective):
...
**Dust collectors** (secondary defense):
...
**Respiratory protection** (last line of defense):
...
- **Resistance** depends on cross-section, perimeter, length, and roughness. A 3×3 m heading with smooth concrete walls has a resistance of roughly 0.005 Ns²/m⁸ per 100 m length. The same heading with rough, timber-supported walls and scattered equipment has 2-5× higher resistance.
