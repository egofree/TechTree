...
|---|---|---|
| Non-uniform doping across wafer (>5% variation center-to-edge) | Gas flow imbalance in MFC delivery, temperature gradient across wafer chuck (±1°C spec exceeded), or showerhead partial blockage | Check MFC calibration (±1% of full scale); verify chuck He backside cooling pressure (2-10 Torr); inspect showerhead holes for polymer buildup — clean with O₂ plasma (500 W, 30 s) or replace |
| Etch rate drift (>10% change over 50 wafers) | Chamber wall conditioning (fluorocarbon polymer accumulation changes surface recombination rate), gas purity degradation, or RF power supply drift | Run 5-10 conditioning wafers to stabilize chamber wall polymer thickness; replace gas cylinder if impurity drifts appear on OES; verify RF forward/reflected power (<5% reflected) |
| Particle contamination on wafer (>10 particles/cm² >0.16 μm) | Gas line particles from valve wear, gas-phase nucleation (SiH₄ decomposing to Si particles in heated lines >80°C), or chamber flaking | Install 0.003 μm point-of-use sintered metal filter; reduce gas line temperature to 60°C for SiH₄ lines (below thermal decomposition onset); purge lines with N₂ at 10× pipe volume; replace worn diaphragm valves after 500,000 cycles |
| PH₃/AsH₃ alarm triggering (gas detected at cabinet exhaust) | Micro-leak at VCR fitting (torque insufficient), cylinder valve stem seal failure, or MFC diaphragm crack | Evacuate area immediately (IDLH: PH₃ 50 ppm, AsH₃ 3 ppm); close source valve at cylinder; N₂ purge system at 5 L/min for 15 min; locate leak with dedicated PH₃/AsH₃ detector (sensitivity <10 ppb); replace VCR gasket and retorque to spec |
| Fluorine gas line corrosion (pitting, blue-green discoloration) | 316L stainless steel exposed to F₂, NF₃, or WF₆ — fluorine attacks the chromium oxide passivation layer | Replace with nickel or Monel (Ni-Cu alloy) piping for all fluorine service; verify all seals are PTFE, Kalrez, or metal gasket; passivate new lines with dilute F₂/N₂ mixture before full service |
| Low etch selectivity (etching mask at >10% of target rate) | Wrong gas mixture ratio (CF₄/O₂ ratio too high increases F· concentration indiscriminately), excess RF bias power (>300 W on 200 mm wafer), or mask material incompatible with etch chemistry | Adjust CF₄/O₂ ratio: add 10-20% O₂ for Si etch, use CHF₃ addition for oxide-selective etch; reduce RF bias power to 100-200 W; switch from photoresist mask to hard mask (SiO₂ or Si₃N₄) for aggressive etches |
| AlCl₃ residue causing post-etch aluminum corrosion (visible under SEM within 24 hours) | Insufficient post-etch passivation — residual Cl on Al surfaces absorbs atmospheric moisture forming HCl | Passivate immediately after Cl₂/BCl₃ etch: CHF₃ plasma (200 W, 30 s) deposits protective fluorocarbon film; or H₂O rinse (DI water, 5 min) dissolves AlCl₃; minimize air exposure between etch and passivation to <2 min |
| Bosch process sidewall scalloping exceeds spec (>200 nm roughness) | Cycle time too long (etch step >10 s allows excessive isotropic undercut), or passivation step too short (<3 s insufficient polymer) | Reduce etch step to 5-8 s (SF₆ at 100-300 sccm); increase passivation step to 4-6 s (C₄F₈ at 80-150 sccm); decrease cycle frequency to 7-12 Hz; trade-off: slower overall etch rate (5-10 μm/min instead of 15-20 μm/min) |
| Bosch process notching at trench bottom (mask undercut) | Notching occurs when ions are deflected by surface charge accumulation on insulating buried oxide (SiO₂) under the silicon trench | Reduce RF bias power near endpoint (last 10% of etch); add low-frequency bias (350 kHz instead of 13.56 MHz) to allow charge dissipation; or switch to SOI-specific Bosch recipe with pulsed bias at oxide interface |
| Silane gas line pressure drop increasing over time | SiH₄ thermal decomposition forming Si deposits in lines (SiH₄ → Si + 2H₂ above 80°C), or particle accumulation at filters | Reduce line heating to 40-60°C (below rapid decomposition onset); install point-of-use filter and monitor pressure drop (replace when ΔP >0.5 psi); purge with N₂ weekly; if deposits severe, replace affected tubing section |
