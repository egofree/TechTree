# Specialty Gases, Consumables, Packaging & Testing

> **Node ID**: `specialty-gases`
> **Domain**: [Specialty Gases, Consumables, Packaging & Testing](./)
> **Dependencies**: `chemistry`, `energy`
> **Enables**: `photolithography`, `photolithography.cleanrooms`
> **Timeline**: Years 20-70+
> **Outputs**: argon, nitrogen, hydrogen, oxygen, silane, dopant_gases, etch_gases, gas_distribution, hepa_filters, packaged_ics, ...
