# SQ 11: Mining Engineering & Extractive Metallurgy

**Starts**: Phase 1
**Priority**: High — ore access is the hard constraint on every metallurgical phase.
...
- **Overburden removal**: Hand shovels and wheelbarrows (Phase 1), animal-drawn scrapers (Phase 2), steam or diesel shovels (Phase 4+). Ratio: overburden-to-ore should be <3:1 for economic viability.
- **Ore extraction**: Break rock with wedges, fire-setting, or explosives (black powder from Phase 5: KNO₃ + S + C at 75:10:15 ratio). Load into carts by hand. Haul to processing area.
...
- **Hydraulic mining** (Phase 4+): Direct high-pressure water jet at hillside to wash gold-bearing gravel through sluice. Requires significant water supply and pressure (20-50 m head).
...
- **Fan ventilation** (Phase 3+): Centrifugal fan (wooden or iron blades in scroll housing), driven by water wheel or steam engine. 5-50 m³/second airflow. Adjustable louvers control flow. Much more reliable than natural ventilation.
...
- **Newcomen engine** (~1712, atmospheric engine): Steam in cylinder → condense → vacuum pulls piston down → pump rod lifted on other end of beam. Lift: 30-50+ m (pump at bottom of shaft, engine at surface). Power: 5-15 HP. THE KEY FEEDBACK LOOP — mine drainage drove steam engine development, which enabled all of Phase 4.
...
**Steam winding engine** (Phase 4+): Horizontal steam engine drives winding drum. Speed 5-15 m/second. Depth 200-500+ m. Load 1-5 tonnes per skip. Guides (wooden or iron rails in shaft) prevent cage rotation. Safety brake (friction brake on drum, held off by steam pressure — loss of pressure = automatic brake application).
...
- **Stamp mill** (Phase 2-3): Vertical iron-shod wooden stamps (50-200 kg each) lifted by cam on rotating shaft, dropped by gravity. 6-12 stamps in battery. Crush ore to 1-5 mm. Water flows through battery, carries fines away. Powered by water wheel. Capacity: 1-5 tonnes/day.
- **Jaw crusher** (Phase 3): Two jaw plates (cast iron or manganese steel), one fixed, one oscillating. Ore fed in top, crushed between jaws. Gap adjustable for output size (10-50 mm). Powered by water wheel or steam engine. 5-50 tonnes/day.
...
**Magnetic separation** (Phase 4+): Magnetite (Fe₃O₄) is naturally magnetic. Pass crushed ore past electromagnet or permanent magnet — magnetic particles deflect, non-magnetic waste continues straight. Effective for iron ore beneficiation.

## Integration Points

| Phase | Contribution |
|-------|-------------|
| Phase 1 | Surface mining, basic prospecting, charcoal for smelting, hand tools |
| Phase 2 | Shaft mining, timber shoring, hand-powered drainage, fire-setting |
| Phase 3 | Machine-driven pumps, precision shafts, iron rails, jaw crushers |
| Phase 4 | **Newcomen engine for mine drainage** — mines DRIVE steam development |
| Phase 5 | Chemical ore processing, flotation, acid leaching, black powder blasting |
| Phase 6 | Ventilation fans, vacuum-assisted processes |
| Phase 7 | High-purity quartz mining, silicon-grade feedstock |
...
- Black powder blasting capability (Phase 5)
- The Newcomen engine, born from mine drainage need, enabling all of Phase 4
