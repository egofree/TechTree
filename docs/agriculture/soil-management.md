...
> **Domain**: [Agriculture](./)
> **Dependencies**: `foundations`, `foundations.food-agriculture`
> **Enables**: `agriculture.soil-management.vermiculture`, `agriculture.crop-production`, `agriculture.biochar`
> **Timeline**: Years 0-10+
...
- Layer materials: alternate 10-15 cm layers of green (nitrogen) and brown (carbon) material. Start with a 15-20 cm coarse brown layer (stalks, twigs) at the base for air circulation. Wet each layer as you build.
- Cap the pile with 5-10 cm of straw, finished compost, or soil to retain moisture and reduce odor.

**Turning schedule**:
- Days 1-14: Turn every 3-5 days. The pile should reach 55-65°C within 48-72 hours. Turning introduces oxygen, mixes materials, and exposes all material to the high-temperature core where pathogen kill occurs.
- Weeks 3-6: Turn weekly. Temperature gradually declines as readily decomposable material is consumed.
- Weeks 7-12+: Turn every 2-4 weeks as needed. The pile cools to ambient temperature. Curing phase — beneficial fungi and soil organisms colonize, producing stable humus.

**Turning technique**: Use a pitchfork or compost fork to disassemble and rebuild the pile, moving outer material to the core and core material to the outside. This ensures all material spends time in the hot zone. With a tractor and front-end loader, simply lift and drop sections of the windrow to remix.

**Pathogen kill requirement** (for humanure or manure-containing compost):
Maintain temperature at 55°C or above for a minimum of 3 consecutive days (for turned piles) or 15 days with a minimum of 5 turnings (for windrows that have periodic temperature variation). These standards ensure destruction of *E. coli*, *Salmonella*, helminth eggs, and other pathogens.
...
**Construction**:
- Lay a 15-20 cm base of coarse wood chips or broken branches. Optionally lay perforated pipes (bamboo with holes, PVC with drilled holes) across the base, extending 30-50 cm beyond the pile edge for air intake.
- Build pile to 1.5-2 m height with mixed feedstock at 25-30:1 C:N ratio.
...
| Feature | Turned Windrow | Static Pile | Vermicompost |
|---------|---------------|-------------|--------------|
| Time to finished product | 3-6 months | 6-12 months | 2-4 months |
| Labor requirement | High (frequent turning) | Low (build and wait) | Moderate (feeding, harvesting) |
| Pathogen kill | Excellent (55-65°C) | Variable (edge effects) | Moderate (gut processing) |
| Suitable feedstocks | All organic materials | Coarse, mixed materials | Kitchen waste, manure, non-fatty waste |
| Nitrogen retention | Good (if C:N correct) | Good | Excellent (worm gut conserves N) |
| Product quality | Good, uniform | Variable | Excellent (high microbial activity) |
...
**Production**:
Build a cone or trench kiln from earth or bricks. Fill with dry woody biomass (branches, crop residues, pruning waste). Ignite from the top. As the fire burns downward, the material below is pyrolyzed by the heat above, with limited oxygen reaching it. Quench with water or soil when the desired char stage is reached (before complete combustion to ash). Alternatively, use a sealed metal drum with small vent holes — biomass is heated from outside (external fire) or inside (top-lit updraft gasifier). Yield: 20-35% of dry biomass weight as biochar.

**Application**:
- Rate: 5-10 tonnes per hectare (0.5-1 kg/m²) for initial application. This is a one-time or infrequent amendment — biochar does not decompose.
- Activate before application: biochar is initially hydrophobic and nutrient-empty. Pre-charge by soaking in compost tea, manure slurry, or mixing with compost for 2-4 weeks before soil application. Uncharged biochar temporarily adsorbs soil nutrients, reducing plant availability.
- Incorporate into top 10-20 cm of soil by digging or tilling. Biochar particles should be crushed to 0.5-5 cm size before application.
- Best results on acidic, low-organic-matter, sandy or highly weathered soils. Less benefit on fertile, high-organic-matter soils.

**Benefits observed in field trials**:
- Water holding capacity increase: 10-30% (especially in sandy soils)
- Cation exchange capacity increase: 20-50%
...
- **Agricultural lime** (ground limestone, calcium carbonate): Apply 2-5 tonnes/ha to raise pH by 0.5-1.0 units. Takes 2-6 months to fully react. Apply in autumn for spring effect.
- **Dolomite lime** (calcium-magnesium carbonate): Raises pH and adds magnesium. Use where magnesium is deficient.
- **Wood ash**: Raises pH (alkaline, potassium carbonate). Apply at 0.5-1 kg/m². Do not over-apply — can raise pH above 7.5 rapidly. Not equivalent to agricultural lime in buffering capacity.

**Lowering pH** (alkaline soils):
- **Elemental sulfur**: Oxidized by soil bacteria to sulfuric acid. Apply 0.5-2 kg/100 m² to lower pH by 0.5-1.0 units. Slow-acting (months).
- **Peat moss**: Acidic (pH 3.0-4.0). Mix into soil at 5-10% by volume.
- **Pine needles / oak leaves**: Moderately acidic as they decompose. Use as mulch around acid-loving crops (blueberries, tea).

**Organic matter targets**:
- Target: 3-5% organic matter by weight in the top 20 cm of soil.
- Below 1%: critically depleted. Intensive composting, green manures, and cover cropping required for years to rebuild.
- 1-3%: below optimal. Regular compost application at 5-10 tonnes/ha/year will increase by 0.2-0.5% per year.
- 3-5%: optimal for most crops. Maintain with annual compost application and cover cropping.
- Above 5%: typical of peat soils and long-term organic management. Generally beneficial but can tie up nitrogen if very high in undecomposed carbon.

**Nutrient testing** (field methods without laboratory):
- **Nitrogen**: Observe plant growth and leaf color. Pale yellow-green leaves indicate nitrogen deficiency. Vigorous dark green growth indicates adequate nitrogen.
- **Phosphorus**: Stunted growth, dark green or purplish leaves (especially on undersides). Difficult to assess visually with precision.
...
**Types**:
- **Arbuscular mycorrhizae** (AM): Associate with 80% of plant species, including most crops. Hyphae penetrate root cells. Essential for phosphorus uptake in low-P soils.
- **Ectomycorrhizae**: Associate mainly with trees (oak, pine, birch). Form a sheath around root tips. Important for forestry.

**Inoculation**:
Collect soil from established, healthy plant communities (forest floor, long-term pasture, native grassland) that likely contains diverse mycorrhizal spores and hyphae. Mix this inoculant soil with potting mix or apply to transplant roots at planting. A handful of forest soil contains millions of mycorrhizal spores. Avoid collecting from diseased or chemically treated soils.

**Maintaining mycorrhizal populations**:
- Minimize soil disturbance (tillage breaks hyphal networks). No-till or minimum-till practices preserve mycorrhizae.
