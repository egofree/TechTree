...
|---------|---------------|----------|
| DNQ/novolac resist shows T-topping after development | Airborne amine contamination (even at ppb levels) neutralizes photoacid at the resist surface | Install chemically filtered air supply (activated carbon + acid-impregnated filter) in lithography bay; maintain <1 ppb amine concentration; seal coated wafers in nitrogen-purged containers between exposure and PEB |
| Photoresist film thickness varies >±5% across 200 mm wafer | Spin coating parameters incorrect or resist viscosity out of spec | Verify spin speed is 3000-5000 RPM for 30 seconds; check resist solids content is 25-35%; ensure dispense volume is 2-4 mL; clean and level the spin chuck |
| BOE undercuts photoresist mask by >200 nm per side | HF attacks SiO₂-Si interface beneath resist; insufficient HMDS adhesion promoter | Apply HMDS (hexamethyldisilazane) adhesion promoter before resist coating; switch to 10:1 or 20:1 BOE for slower etch rate (~25-50 nm/min); consider vapor-phase HF etching to eliminate liquid undercut entirely |
| TMAH development produces non-uniform pattern | Developer temperature varies more than ±0.5°C across the wafer; development rate changes ~5%/°C | Maintain development temperature at 23 ± 0.5°C; verify 60-90 second puddle development time; use endpoint detection monitoring optical absorption at 310 nm |
| CMP removal rate below 100 nm/min for oxide planarization | Preston's equation parameters (pressure × velocity) insufficient or slurry pH drifted from 10.11 | Increase downforce to 3-5 psi or platen speed to 150-300 ft/min; verify colloidal silica slurry (30-70 nm particles) at 12-30 wt% solids; check zeta potential is <-30 mV for proper particle dispersion |
| Copper CMP leaves residual scratches on wafer surface | Alumina abrasive (100-200 nm) too aggressive; BTA corrosion inhibitor concentration too low | Switch to colloidal silica abrasive (30-50 nm, gentler finish); increase benzotriazole (BTA) to 0.01-0.1% for better passivation of recessed areas; verify pH is 4-7 |
| Post-CMP cleaning leaves silica particles on wafer | Megasonic power density insufficient or PVA brush contamination | Increase megasonic power to 10-50 W/cm² at 0.8-1.6 MHz; use dilute NH₄OH (1-2%) at 20-40°C in PVA brush scrub for electrostatic particle repulsion; verify Marangoni (IPA vapor) drying eliminates water marks |
| Piranha solution boils or reacts violently with organics | H₂O₂ added to H₂SO₄ in wrong order, or large amount of organic material introduced | ALWAYS add H₂O₂ to H₂SO₄ (never reverse); prepare fresh and use within 30-60 minutes before peroxide decomposes; never add significant organic material — piranha reacts explosively with solvents or photoresist chunks |
