...
- **E-glass** (electrical grade, the workhorse of fiberglass): 54% SiO₂, 14% Al₂O₃, 22% CaO, 0.5% MgO, 7% B₂O₃, 1% Na₂O/K₂O by weight. The low alkali content gives good electrical resistivity and moisture resistance. Melting point: ~1200°C; working temperature: 1200-1400°C.
- **S-glass** (structural grade, higher strength): 65% SiO₂, 25% Al₂O₃, 10% MgO. Tensile strength 40-50% higher than E-glass, but requires higher melting temperature (~1500°C) and more energy to produce. Used in aerospace and ballistic armor.
...
**Direct melt process** (standard industrial method):
...
**Phenolic resin production** (bootstrap path):
...
**Hand lay-up** (simplest composite method):
...
**Vacuum bag molding** (higher fiber content, stronger laminates):
...
**Pultrusion** (continuous profile production):
