...
**Toulouse**:
Named for the French city, bred in two distinct types. The **production Toulouse** is a moderate-sized gray goose (ganders 9-11 kg, geese 7-9 kg) that forages well and produces 30-50 eggs per year. The **dewlap Toulouse** (exhibition type) is enormous — ganders 12-15 kg, geese 9-12 kg — with a heavy body, dewlap flap of skin under the chin, and keel extending nearly to the ground. Dewlap Toulouse are poor foragers due to their bulk and require supplemental feed. Production Toulouse are the practical working breed.

**Chinese goose** (*Anser cygnoides domesticus*):
Descended from the swan goose. Lighter build than European breeds — ganders 5-6 kg, geese 4-5 kg. Most prolific egg layer among geese: 50-80 eggs per year. Distinctive large basal knob on the upper bill (more prominent in males). Excellent foragers and highly alert — Chinese geese are the noisiest breed and the most effective guardians. Available in white and brown color varieties. The leaner carcass and higher egg production make them the preferred homestead goose.

**African goose**:
A large breed of swan goose descent (despite the name, developed in North America). Ganders 9-12 kg, geese 7-9 kg. Brown and white plumage with prominent basal knob. Good meat yield, moderate egg production (30-40 per year). Hardy in cold climates despite tropical origin.

**Pilgrim**:
An auto-sexing breed — males are white, females are gray. This is one of the few poultry breeds where chicks can be sexed by color at hatching. Moderate size: ganders 6-7 kg, geese 5-6 kg. Calm, good foragers. Developed in North America. Egg production: 30-40 per year.

**Breed comparison**:
| Feature | Embden | Toulouse (prod.) | Chinese | African |
|---------|--------|-------------------|---------|---------|
| Adult weight (gander) | 11-14 kg | 9-11 kg | 5-6 kg | 9-12 kg |
| Adult weight (goose) | 8-10 kg | 7-9 kg | 4-5 kg | 7-9 kg |
| Eggs/year | 30-40 | 30-50 | 50-80 | 30-40 |
| Egg weight | 160-200 g | 150-190 g | 140-160 g | 150-180 g |
| Foraging ability | Good | Good | Excellent | Moderate |
| Noise level | Moderate | Moderate | Loud | Moderate |
...
**Weeder geese**:
Geese selectively graze grasses and broadleaf weeds while ignoring many established crops. This behavior has been exploited for biological weed control in cotton fields (geese remove grasses between cotton rows without damaging the crop), strawberry beds (geese eat weeds and remove diseased leaves), orchards (geese graze the understory, reducing habitat for rodents that gnaw tree bark), and vineyards. Stocking rate for weeding: 2-4 geese per 1,000 m² of crop area. Weeder geese must be removed before the crop produces fruit or seeds that attract them.

**Forage preferences**:
Geese prefer young, tender grass shoots, clover, dandelion, chickweed, and other broadleaf forbs. They avoid mature, woody vegetation. Provide access to fresh grazing by rotational paddock systems — move geese to new pasture every 3-5 days to prevent overgrazing. Geese return nutrients to the pasture through their manure, maintaining soil fertility.
...
**Fencing**:
Geese respect most fencing and can be contained with a 90-120 cm fence. They do not climb or fly well (most breeds are too heavy). Goslings can squeeze through gaps — use wire mesh with openings under 5 cm for young birds. Electric fencing at 10-15 cm and 40-50 cm above ground deters ground predators.
...
**Seasonal laying**:
Geese are triggered to lay by increasing daylight in late winter/early spring. Production season: February through May (northern hemisphere). A goose lays a clutch of 8-15 eggs over 3-4 weeks before going broody, or eggs can be collected daily to extend the laying period to 30-50 eggs total.

**Natural incubation**:
Geese make excellent broody mothers. A broody goose sits on 8-12 eggs for 28-30 days. She turns the eggs, maintains temperature, and aggressively defends the nest against predators (including humans — use a stick or shield when approaching a broody goose). Goslings hatch precocial (eyes open, covered in down, able to walk and feed within hours). The mother leads them to food and water and protects them for 8-10 weeks. Allow natural brooding whenever possible — goose mothers are attentive and effective.

**Artificial incubation**:
Incubator temperature: 37.2-37.5°C, humidity 55-65% for first 27 days. Turn 3-5 times daily. Increase humidity to 70-75% for hatching (days 28-30). Goose eggs are large and require careful handling. Cool eggs briefly (5-10 minutes) once daily after day 10 — goose eggs have a high metabolic heat load and benefit from cooling, which mimics the mother leaving the nest to feed. Hatch rate: 60-75% from fertile eggs.
...
**Processing timing**:
Traditional slaughter timing is at 20-24 weeks for spring-hatched goslings, or at the Michaelmas feast (September 29) when geese have fattened on harvest stubble. Spring-hatched goslings on good pasture reach 5-7 kg by late autumn with minimal supplemental feed. Force-feeding for foie gras (fatty liver) is a specialized practice requiring specific breeds (Toulouse-derived lines) and equipment — it is not required for standard meat production.
...
**Harvest methods**:
- **Post-slaughter plucking**: Most common method. Pluck feathers and down after scalding (60-65°C for 60-90 seconds). Separate down from larger feathers by hand or mechanical sorting. Down is the most valuable component.
- **Live-plucking**: Practiced in some regions but controversial. Geese can be plucked of mature down 2-3 times per year during natural molting periods, yielding 60-100 g per plucking. Geese must be handled carefully to avoid skin tears. Some regions prohibit live-plucking.
- **Molt collection**: Collect naturally shed down and feathers from goose shelters during molting season (summer). Labor-intensive and yields are low, but it is non-invasive.

**Down processing**:
1. Sort to separate down from feathers (down has no quill shaft — it is a fluffy three-dimensional structure).
2. Wash in warm water with mild detergent.
3. Rinse thoroughly.
4. Dry in a tumble dryer on low heat with clean tennis balls (to fluff and separate clusters) or spread thin in the sun.
5. Final sorting to remove any remaining feather fragments.

**Down applications**:
- **Insulation**: Fill for quilts, sleeping bags, jackets, and pillows. Down provides approximately 3-4 times the insulation per unit weight of synthetic alternatives. Measured in fill power (volume in cubic inches that 1 ounce of down occupies): good quality 500-600, premium 700-800, exceptional 800+. Fill power degrades with moisture and compression — store down items uncompressed in dry conditions.
- **Bedding**: A standard pillow requires 500-800 g of down. A queen-size duvet requires 800-1200 g depending on warmth rating.
...
**Common issues**:
- **Angel wing**: Same as ducks — twisted wing joint from excess protein/calories during rapid growth. Reduce protein to 14-15% after 4 weeks if symptoms appear.
- **Botulism**: Risk from stagnant water. Keep water sources clean and flowing where possible.
- **Foot infections (bumblefoot)**: Heavy geese on rough or abrasive surfaces develop foot pad infections. Provide clean, smooth flooring and pasture.
...
**Size and handling**:
Adult geese are large, strong birds (5-14 kg) that resist handling vigorously. To catch a goose: use both arms to control the wings (pin wings against the body), grasp the neck gently but firmly (do not choke — hold at the base of the neck), and tuck the bird under your arm. A flapping goose wing can deliver a painful blow to the face. Approach calmly and handle with confidence — hesitation encourages resistance.
