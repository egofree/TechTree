...
[← SQ 14: Polymers & Composites](../side-quests/sq-14-polymers-composites.md)

## Precursors

All elastomers need vulcanization chemistry (sulfur or peroxide crosslinkers) and reinforcing fillers. Natural rubber comes from latex-bearing plants. Synthetic rubbers and silicones need petrochemical or chlorosilane feedstocks from [SQ 12](../side-quests/sq-12-petrochemicals.md).
...
**Precursors**: Butadiene + acrylonitrile (both from [SQ 12](../side-quests/sq-12-petrochemicals.md) cracking and ammoxidation).
...
**Precursors**: Dimethyl dichlorosilane → hydrolysis → cyclic/linear siloxanes. Chlorosilane route ties to Phase 5 chloride chemistry and [SQ 12](../side-quests/sq-12-petrochemicals.md) silicon metal production.
...
**Precursors**: Chloroprene monomer. Two routes: (a) acetylene + HCl (older route), or (b) butadiene + Cl₂ followed by dehydrochlorination (modern route, requires [SQ 12](../side-quests/sq-12-petrochemicals.md) butadiene).
...
|-----------|----------|-----------------|-------|
| Two-roll mill | Compounding, sheet formation, mastication | Phase 3 | Cast iron or steel rolls, adjustable gap, friction ratio 1:1.2 to 1:3 |
| Banbury internal mixer | High-shear batch compounding | Phase 3+ | Faster than open mill, enclosed chamber with rotors |
| Calender | Continuous sheet formation to controlled thickness | Phase 3+ | 3-4 roll configurations, 0.1-5 mm thickness range |
| Compression molding press | Vulcanization of shaped parts | Phase 3+ | Hydraulic or mechanical, heated platens, 50-200 ton capacity |
| Steam autoclave | Batch vulcanization of extruded or wrapped goods | Phase 4 | Steam at 3-10 bar, temperature control ±2°C |
| Extruder (rubber) | Continuous profiles (hoses, tubing, weatherstrip) | Phase 3+ | Cold-feed or hot-feed screw design, downstream vulcanization |
| Autoclave/RTV chamber | Silicone curing (addition-cure grades) | Phase 5 | Temperature-controlled oven, optional vacuum degassing |

Phase dependencies: Mills, calenders, and presses rely on Phase 3 cast iron and machining capability. Steam autoclaves require Phase 4 boiler and steam systems. Silicone processing needs Phase 5 chlorosilane chemistry.

### Key Milestones

- [ ] **Phase 4**: Natural rubber vulcanization (latex collection → sulfur cure → gaskets, belts, seals)
- [ ] **Phase 4**: Two-roll mill and compression press operational for rubber compounding
- [ ] **Phase 5**: Nitrile rubber (NBR) production once butadiene and acrylonitrile feedstocks available from SQ 12
- [ ] **Phase 5**: Neoprene production once chloroprene monomer route is established
- [ ] **Phase 5**: Calender and extruder operational for continuous rubber sheet and profiles
- [ ] **Phase 5**: Silicone elastomer production via peroxide cure once chlorosilane chemistry is online
- [ ] **Phase 6+**: Platinum-catalyzed silicone (addition cure) for precision medical and electronic-grade parts
- [ ] **Phase 7+**: Fluoroelastomers for aggressive chemical environments (semiconductor fab seals, plasma equipment)
