...
|---------|---------------|----------|
| Dry spots (white, unmatted areas) in hand-layup laminate | Insufficient resin applied; consolidation roller not worked thoroughly; fabric bridging over mold contours | Apply resin by brush or roller in thin coats, working from center outward; use serrated consolidation roller to push resin into fiber and remove entrapped air; for complex contours, use smaller fabric pieces cut on bias (±45°) |
| Laminate void content exceeding 5% (visible bubbles, weak spots) | Hand layup without vacuum bagging; trapped air between layers; resin viscosity too high for wet-out | Vacuum bag to 0.5-1.0 bar (85-95% atmospheric pressure) to reduce voids below 1%; warm resin slightly (25-30°C) to lower viscosity for better wetting; apply consolidation roller systematically across each layer |
| Polyester resin gelling too fast (under 20 minutes working time) | MEKP catalyst overdose; workshop temperature above 30°C; resin batch already partially aged | Reduce MEKP catalyst to 1-2% by weight (not volume) of resin; work in temperature-controlled environment (20-25°C ideal); use fresh resin — aged resin has shorter pot life; resin should gel in 20-60 minutes at room temperature |
| Cured laminate delaminating between plies under moderate load | Poor interlaminar bonding; contamination between layers; insufficient consolidation pressure during cure | Clean each layer before adding the next (no dust, oil, or release agent); ensure previous layer is still tacky before adding resin and next ply; vacuum bag to apply 0.08-0.10 MPa consolidation pressure uniformly |
| Composite part stuck to mold after cure | Release agent not applied or applied incorrectly; gel coat cured too long before layup (beyond tacky stage) | Apply paste wax or PVA release agent per manufacturer instructions (2-3 coats); do layup while gel coat is still tacky (30-60 minutes for polyester); if stuck, tap gently with rubber mallet and use compressed air at parting line |
| Styrene fumes causing dizziness and headache during layup | Open-mold hand layup with 30-40% styrene in polyester resin; inadequate ventilation (safe threshold below 100 ppm) | Use local exhaust ventilation at work surface; wear organic vapor cartridge respirator; keep ignition sources away (styrene flash point 31°C); consider switching to low-styrene-emission resin or epoxy for indoor work |
| Fiber volume fraction below 30% (heavy, resin-rich laminate) | Too much resin relative to fabric; no consolidation to squeeze out excess; random chopped strand mat inherently limited to 20-30% | Use woven fabric (40-50% Vf achievable) instead of chopped strand mat; vacuum bag to squeeze excess resin through bleeder cloth into breather layer; target 50-55% Vf with vacuum bagging on woven fabric |
| Epoxy sensitization (persistent skin rash after contact) | Repeated skin exposure to uncured epoxy resin or amine hardener; allergy becomes permanent once sensitized | Wear nitrile gloves (not latex — epoxy penetrates latex); change gloves immediately if contaminated with resin; minimize all skin contact with uncured materials; once sensitized, avoid all epoxy contact — the allergy is irreversible |
| Carbon fiber dust short-circuiting electronic equipment in workshop | Airborne carbon fiber particles are electrically conductive; CNC machining without dust extraction | Isolate carbon fiber cutting/sanding from electronic equipment; use HEPA vacuum extraction at the cutting tool; enclose CNC machines processing carbon fiber; clean workshop with HEPA vacuum — never dry-sweep |
| Polyester resin curing with waxy surface film (air inhibition) | Oxygen in air prevents surface cure of polyester; styrene monomer evaporates from surface before crosslinking completes | Apply a thin coat of polyvinyl alcohol (PVA) film or cover with plastic film to exclude air; add 0.1-0.5% paraffin wax to resin (rises to surface and seals from air); post-cure at 60-80°C for 2-4 hours to drive complete crosslinking |
