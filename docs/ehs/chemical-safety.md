...
|---------|---------------|----------|
| Gas sensor reading drift or false alarms | Electrochemical cell reaching end of life (1-3 year span); temperature/humidity cross-sensitivity; calibration gas expired or incorrect concentration | Replace sensor cell per manufacturer schedule (do not exceed rated life); verify calibration gas concentration and expiry date; recalibrate with fresh span gas; check sensor housing for condensation or contamination |
| Arsine/phosphine sensor not alarming during known release | Sensor positioned at wrong height (AsH₃ is 2.7× air — accumulates at floor; PH₃ is 1.2× air — mixes throughout); sensor dead or disconnected; alarm threshold set too high | Verify sensor mounting height (breathing level for PH₃ at 1.5 m, low level for AsH₃ at 0.3-0.5 m); check sensor status indicator and wiring; verify alarm setpoints are at 50% of PEL (AsH₃: 0.025 ppm, PH₃: 0.15 ppm); test with bump gas |
| HF skin exposure — pain delayed or absent | Dilute HF (≤10%) causes delayed symptoms (12-24 hours); victim may underestimate severity; fluoride ions continue binding tissue calcium | Treat ANY HF skin contact as serious regardless of pain; flush 15+ minutes with water; apply 2.5% calcium gluconate gel immediately and massage continuously; do not wait for pain to develop; seek medical evaluation for all exposures |
| Silane sensor alarm but no visible fire | Low-concentration leak below autoignition threshold; sensor detecting residual silane after a brief ignition event; cross-sensitivity from hydrogen or other reducing gases | Do not assume false alarm — investigate with thermal imaging camera for invisible combustion; check gas cabinet exhaust monitoring; verify with second sensor type (IR vs. thermal conductivity); if leak confirmed, close cylinder valve and purge with N₂ |
| Scrubber breakthrough — toxic gas detected in exhaust | Scrubber media exhausted (carbon saturated, caustic solution depleted); exhaust flow rate exceeding scrubber capacity; channeling through packed bed | Replace scrubber media on schedule (do not wait for breakthrough); verify exhaust flow rate is within scrubber design capacity; check caustic solution pH (replace when pH drops below 10); inspect packed bed for channeling or flooding |
| Calcium gluconate gel ineffective on HF burn | Gel applied too late (fluoride already bound deep tissue); inadequate gel quantity; exposure area not fully covered | Apply gel immediately and generously — reapply every 15 minutes; for deep burns or >5% body surface area, inject 5% calcium gluconate subcutaneously (trained medical personnel only); all HF exposures require emergency room evaluation regardless of initial response |
| Air sampling result shows exposure above PEL but no gas alarm triggered | Task-based exposure during cylinder change or maintenance (brief spike averaged into TWA); sensor location not covering the work area; alarm threshold set at TLV not PEL | Review work practices for cylinder change procedures (is purge cycle adequate?); add portable personal monitor for maintenance tasks; check that sensors cover all gas cabinet and VMB locations; verify alarm setpoint hierarchy (low alarm at 50% TLV, high at TLV) |
| Electrochemical sensor responds sluggishly or not at all to bump test | Cell electrolyte dried out (high-temperature environment); membrane clogged by dust or condensate; cell past end-of-life date | Replace cell immediately — do not return to service; verify sensor environmental rating matches installation conditions (humidity, temperature); check that sensor is not installed near ventilation exhaust where airflow dilutes sample |
