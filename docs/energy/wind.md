...
**[Wind power density](../glossary/wind-power-density.html)** (power available per unit area swept by the rotor):
- P = 0.5 × ρ × A × v³ × Cp
...
**[Post mill](../glossary/post-mill.html)** (earliest, simplest — 12th century onward):
...
**[Tower mill](../glossary/tower-mill.html)** (improved — 14th century onward):
...
**[Smock mill](../glossary/smock-mill.html)** (tower mill variant — common for drainage pumping):
...
**[Common sail](../glossary/common-sail.html)** (cloth on wooden frame — standard for centuries):
...
**[Spring sail](../glossary/spring-sail.html)** (wooden shutters — 1772, Andrew Meikle):
...
**[Patent sail](../glossary/patent-sail.html)** (spring sail variant with hinged flaps):
...
**[Anemometer](../glossary/anemometer.html)** (cup anemometer, 1846 — but simpler methods suffice):
...
**[Gear train](../glossary/gear-train.html)** (wooden gears — standard technology):
...
**[Farm wind pump](../glossary/farm-wind-pump.html)** (American water-pumping windmill — 1854 onward, but buildable with iron-age technology):
