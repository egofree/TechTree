...
> **Enables**: [`energy.gravity.water-turbines`](./water-turbines.md),
> [`energy.storage.pumped-hydro`](./pumped-hydro.md)
> **Timeline**: Years 5-15
...
|---------|---------------|----------|
| Overshot wheel efficiency dropped below 50% (should be 60–70%) | Bucket lips worn or broken, allowing water to spill during descent; or tailrace water level risen to submerge lower buckets, creating back-drag on the ascending side | Inspect all 30–80 buckets for worn or missing lips — replace damaged oak buckets. Measure tailrace water level: must be at least 30 cm below the lowest bucket at maximum flow. Clear tailrace of sediment or debris causing back-flooding. Verify bucket spacing: maximum gap of 50–80 mm between adjacent buckets |
| Undershot wheel producing less than 0.5 HP (expected 0.5–3 HP) | Water velocity at paddle face below the 0.5 m/s minimum; or paddle immersion too shallow (<20 cm) to capture adequate flow impulse | Measure water velocity with float test over 10 m distance (target >0.5 m/s). Deepen or narrow the mill race channel to concentrate flow onto paddles — a sluice gate can accelerate water to usable velocity. Increase paddle immersion to 20–40 cm in the flowing stream. Check that paddle depth has not shifted — seasonal sediment changes the streambed profile |
| Bearing temperature exceeding 60°C after 1 hour of operation | Insufficient lubrication (tallow depleted or washed away by water splash); or axle misaligned causing edge-loading on the stone block or iron collar bearings | Grease bearings with fresh tallow before each operating day. Check axle alignment with a straightedge — axle must be level and perpendicular to the wheel within 5 mm over its length. If using stone bearings, verify the bearing socket is not worn into an oval shape (creates uneven contact and heat). For iron collars on hardwood, check clearance is 0.5–1.0 mm for lubricant film |
| Breastshot wheel losing 10–20% of power to breast wall gap | Breast wall (stone or timber) settled or eroded, opening gaps >20 mm around the lower wheel arc; water spills from buckets without doing work | Check breast wall clearance around the full arc — maximum 10 mm gap. Repack gaps with oakum and seal with hydraulic cement or clay. For timber breast walls, replace rotted sections and re-peg to the frame. For stone walls, reset displaced stones and point all joints. Efficiency should recover to 35–50% range with a tight seal |
| Line shaft vibration and bearing overheating in workshop | Shaft misalignment (hung bearings not level to within 0.05 mm/m) or shaft out of balance from uneven wear on the 50–100 mm diameter iron shaft | Check bearing hanger alignment with a taut wire along the shaft length — all bearing centers should be collinear within 1 mm. Verify shaft is straight (roll on V-blocks, check runout <0.5 mm). Re-balance by adding or removing weights at the heavy spot. Replace worn babbitt bearings if oil grooves are visible through the lining (indicates <0.5 mm remaining) |
| Dam seepage through earth embankment | Puddle clay core cracked from drying or insufficient compaction (200–300 mm lifts at optimum moisture content 12–18%); seepage path forming through the core | Monitor seepage flow rate at the toe — increasing flow indicates internal erosion (piping). If seepage is clear and stable, add clay fill on the upstream face (underwater placement is acceptable). If seepage is turbid (carrying soil), this is an emergency: lower the pond level immediately and excavate to repair the core. Never allow piped seepage to continue — it can empty the pond through the dam in hours |
| Sluice gate not sealing (wheel won't stop when gate is closed) | Wooden slide gate warped or swollen from water immersion; gate must seal within 5 mm to stop the wheel but has warped beyond that tolerance | Remove gate and plane the contact surfaces flat. Soak replacement gate in water before final fitting so swelling is accounted for. Check the gate guides (grooves in the masonry or timber frame) are not worn — a loose gate rocks in its guides and cannot seal. For iron gates, verify the frame is not corroded and that the lifting screw operates freely |
| Flat belt slipping on pulley, losing 2–5% beyond normal slip | Belt too loose (insufficient tension) or belt glazed from oil contamination; leather/canvas belt cannot grip the pulley face, especially under peak torque loads | Tighten belt tension using the take-up pulley or moveable bearing. Clean belt and pulley faces with solvent to remove oil glaze. Dress leather belts with belt dressing (rosin-based) to restore grip. Verify pulley diameter is at least 30× belt thickness — smaller pulleys cause cracking and reduced grip. Replace stretched belts that cannot be tensioned adequately |
| Wooden gear teeth breaking on the lantern pinion | Shock load from flow variation exceeding what apple/hornbeam teeth can carry (rated for <5–10 HP); or teeth dried out and brittle from lack of tallow/tar lubrication | Replace broken teeth with new hardwood pegs (apple, hornbeam, or ironbark), driven into the hub from the outside. Grease all teeth with tallow or tar weekly. If breakage is recurrent, consider upgrading to cast iron gear rims with machined teeth for loads above 5–10 HP. Inspect for foreign objects (branches, ice chunks) jamming the gear train |
| Penstock pipe leaking at joints (steel, 10–50 bar rated) | Gasket deterioration or bolt corrosion at flanged joints; water escaping under pressure erodes the joint material and worsens the leak | Shut down the turbine and isolate the penstock. Replace the failed gasket with new rubber or compressed fiber gasket of correct specification for the pressure rating. Clean flange faces to bare metal. Re-torque bolts in a crisscross pattern to uniform tension. Inspect all other flanged joints — adjacent joints are subject to the same pressure cycles and may be near failure |
