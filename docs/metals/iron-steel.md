...
> *Trends in productionof iron ore, pig iron and steel in the United States, 1880—1900, gross tons.*
...
**[Cupola furnace](../glossary/cupola-furnace.md)** (for remelting pig iron and scrap):
...
**[Sand casting](../glossary/sand-casting.md)** (the primary molding method for cast iron):
...
**[Brazing](../glossary/brazing.md)** (joining with filler metal, later stages):
...
**[Soft soldering](../glossary/soft-soldering.md)** (lowest temperature joining):
...
**[Spring making](../glossary/spring-making.md)** (critical for mechanisms, locks, suspensions, valves):
...
**[Surface hardening methods](../glossary/surface-hardening-methods.md)** (hard surface + tough core):
...
- **[FCC metals](../glossary/fcc-metals.md)** (austenitic stainless, aluminum, copper) do not exhibit a DBTT — they remain ductile to cryogenic temperatures.
