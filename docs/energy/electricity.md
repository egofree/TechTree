...
> [`energy.electricity.power-systems`](./power-systems.md),
...
> [`machine-tools.joining.laser-welding`](../machine-tools/laser-welding.md),
> [`machine-tools.joining.mig-welding`](../machine-tools/mig-welding.md),
> [`machine-tools.joining.resistance-welding`](../machine-tools/resistance-welding.md),
