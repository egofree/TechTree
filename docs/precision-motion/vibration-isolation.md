...
> **Dependencies**: `construction`, `gas-handling`
...
|---------|---------------|----------|
| Floor vibration at 5-30 Hz exceeds VC-D criterion (6.25 μm/s RMS) — lithography scanner image blur | Road traffic within 20-100 m of building; HVAC rotating machinery transmitting through foundation; insufficient structural decoupling | Install equipment on isolated inertia block (10-100 tonnes, separated by 50-100 mm air gap); relocate precision tools >15-30 m from vibrating machinery; upgrade to active vibration isolation with voice coil actuators for 1-30 Hz cancellation |
| Pneumatic isolator amplifies vibration 3-10× at resonance (0.5-3 Hz natural frequency) | Passive isolation system has inherent transmissibility peak at f_n; damping ratio only 2-8% of critical is insufficient to suppress peak | Increase damping ratio toward 8% with larger damping chamber orifice; add active voice coil cancellation at resonance frequency; upgrade to combined passive + active system reducing transmissibility at 1 Hz from 2-5× to <0.5 |
| Isolated platform drifts ±0.1 mm — automatic leveling valves cannot maintain height | Air supply pressure fluctuating below 2-8 bar spec; leveling valve contaminated or worn; thermal expansion of payload shifting center of gravity | Install pressure regulator with reservoir tank for stable air supply; clean or replace leveling valves; verify payload mounting does not shift with temperature; recalibrate leveling valve set points after payload changes |
| Active isolation system reverts to passive mode during power fluctuation — transient oscillation disrupts measurement | Power loss causes voice coil actuators to go passive; platform oscillates at 0.5-3 Hz natural frequency for 2-5 seconds | Install UPS (uninterruptible power supply) with >30 second holdup for active isolation electronics; design equipment to tolerate brief passive-mode oscillation; configure active system for graceful re-engagement after power recovery |
| Vibration at 50/60 Hz mains frequency exceeds specification at isolated payload | Electrical mains harmonics coupling through equipment power supplies; nearby transformers generating magnetic field vibration; active cancellation not targeting this frequency | Add narrow-band feedforward cancellation at 50/60 Hz in active isolation controller; install power line EMI filters on equipment; relocate transformers >5 m from precision tools; verify active system geophones detect at 50/60 Hz |
| Electron microscope column vibration exceeds 0.5 nm RMS — image resolution degraded | Acoustic noise coupling to column; building structural resonance excited by wind; AC magnetic fields deflecting electron beam | Install acoustic enclosure around column; add μ-metal magnetic shielding for AC field rejection; verify passive pneumatic isolators at 0.5-1 Hz natural frequency; measure and mitigate nearby AC magnetic field sources (motors, power cables) |
| Optical table vibration exceeds 10 nm — interferometry fringes unstable | Pneumatic table legs at 1-2 Hz natural frequency amplifying foot traffic (1-10 Hz); table top resonance modes excited by acoustic noise | Relocate table away from foot traffic paths; install acoustic enclosure; check table leg air pressure and leveling; add rubber mat under table for additional damping; verify honeycomb core integrity — replace table if skins delaminated |
| Inertia block rocking mode excited by wafer stage reaction forces (1500 N at 30 m/s²) | Equipment center of gravity too high relative to block center; insufficient block mass — block mass <5× equipment mass; rocking mode frequency coincides with stage acceleration profile | Increase block mass to ≥5× equipment mass; lower equipment mounting to minimize CG offset; add lateral damping at block edges; verify stage reaction force compensation (reaction masses) is functioning |
| Floor vibration site survey fails VC-E (<3.12 μm/s RMS) for EUV lithography installation | Foundation slab transmitting vibration from adjacent production equipment; 24-hour survey reveals periodic HVAC compressor cycling spikes | Install equipment on deep foundation pile isolated from building slab; reschedule HVAC compressor cycling to off-peak hours; add local active isolation platform at tool base; consider structural decoupling with expansion joints between foundation slabs |
| Isolation system settling time of 2-5 seconds too slow for high-throughput wafer stage | Passive-only system with 2-8% damping requires multiple cycles to decay after each stage step; natural frequency 0.5-3 Hz limits decay rate | Upgrade to active isolation reducing settling time from 2-5 s to 0.2-0.5 s; tune active feedback controller for faster settling without instability; verify voice coil actuator bandwidth reaches 1000 Hz for rapid disturbance rejection |
