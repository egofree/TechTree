...
> **Node ID**: health.emergency-care
> **Domain**: [Health](./index.md)
> **Dependencies**: [`health.medicine`](medicine.md), [`health.surgery-basics`](surgery-basics.md), [`health.pharmacology`](pharmacology.md)
> **Enables**: (supporting capability for trauma and mass-casualty response)
> **Timeline**: Years 5-100+
> **Outputs**: triage_capability, hemorrhage_control, burn_management, fracture_management
> **Critical**: Yes — emergency procedures prevent death in the first minutes to hours after injury

Emergency care covers mass-casualty triage, hemorrhage control, burn management, shock resuscitation, fracture reduction and immobilization, and dental emergencies. These are the time-critical interventions where minutes determine survival. Wound suturing technique and surgical procedures are covered in [Surgery Basics](surgery-basics.md). Drug preparation and dosing are covered in [Pharmacology](pharmacology.md).
...
- **Drug overdose**: Many pharmaceutical compounds have narrow therapeutic windows. Weigh all drugs on accurate scales. Start with lowest effective dose. Digitalis, morphine, and ether have particularly dangerous overdose profiles. See [Pharmacology](pharmacology.md) for dosing reference.
...
| Burn patient develops low urine output despite fluid resuscitation | Under-resuscitation or inadequate monitoring | Re-calculate Parkland formula: 4 mL × kg × %BSA; ensure first half given in first 8 hours; target urine output 0.5-1.0 mL/kg/hour; increase rate if output below target |

## See Also

- [Medicine & Surgery](medicine.md) — overview hub for all medical capabilities
- [Surgery Basics](surgery-basics.md) — wound assessment, suturing technique, sterilization, anesthesia
- [Pharmacology](pharmacology.md) — drug preparation, dosing, quality control
- [Medical Instruments](medical-instruments.md) — surgical and diagnostic instrument fabrication
