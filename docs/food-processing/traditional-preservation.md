...
Traditional preservation methods — drying, salting/curing, and smoking — are the oldest food preservation techniques, achievable with stone-age technology. Each method either removes water (drying) or creates hostile chemistry (salt osmotic pressure, smoke antimicrobial compounds) to inhibit microbial growth. These methods eliminate seasonal starvation cycles and enable food transport and storage without any industrial infrastructure.

For other preservation methods, see [Canning & Thermal Sterilization](canning.md), [Food Fermentation](fermentation.md), [Pasteurization](pasteurization.md), and [Refrigeration](refrigeration.md). This article covers only drying, salting/curing, and smoking.
...
- **Community preservation** (50-200 people): Dedicated drying shed, barrel salting operation. Throughput: 100-500 kg per batch. 2-3 workers per session. Requires dedicated building with ventilation and water supply.
- **Industrial preservation** (10,000+ people): Continuous drying tunnels, automated salting lines. Throughput: 1-50 tonnes/day. 20-100 workers. Requires steam supply, electrical power, and transportation infrastructure.
...
- **Botulism is the primary hazard** in smoking and curing. Cold smoking at 20-30°C in anaerobic conditions creates ideal conditions for *C. botulinum*. Always salt or brine before smoking to reduce water activity.
...
- [Ceramics](../ceramics/index.md) — storage vessels, jars, pots
- [Mining](../mining/index.md) — salt production for curing
