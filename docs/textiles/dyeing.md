...
- **Iron (ferrous sulfate, FeSO₄)**: Darkens and "saddens" colors — turns yellow to olive, blue to gray-black. Make by dissolving iron scraps in vinegar (acetic acid) or stale urine. Use 2-5% of fiber weight. Overuse embrittles protein fibers.
- **Copper (copper sulfate, CuSO₄)**: Brightens greens and shifts yellows toward green. Use 2-5% of fiber weight. Toxic in high concentrations — handle with care.
- **Tannin (from oak galls, sumac, chestnut, pomegranate rind)**: Essential pre-mordant for cellulose fibers. Boil 20-30% of fiber weight of tannin-rich material, strain, soak fiber 2-4 hours before alum mordanting.
...
1. Extract dye: Chop/bruise plant material. Cover with soft water (rainwater preferred — hard water contains calcium that interferes with some dyes). Simmer 1-2 hours. Strain through cloth.
2. Prepare bath: Add enough water to submerge fiber freely. Dissolve mordant (if applying in same bath — "one-bath" method) or use pre-mordanted fiber.
3. Enter fiber: Wet fiber thoroughly first (pre-wetting ensures even uptake). Add to dye bath at 40°C, raise slowly to target temperature over 30 minutes.
4. Maintain: Hold at temperature for 1-2 hours, stirring occasionally. Remove heat and let cool in bath overnight for deeper shades.
5. Rinse: Rinse in progressively cooler water until rinse water runs clear. Dry away from direct sunlight (UV degrades some dyes).

### Fastness Testing

- **Wash fastness**: Wash dyed sample in warm water with mild soap (5 min, 40°C). Compare color loss against unwashed control. Acceptable: minimal fading after 5 washes.
- **Light fastness**: Expose half the sample to direct sunlight for 1-2 weeks (cover the other half). Compare. Weld yellow and indigo blue are excellent; many berry dyes fade rapidly.
- **Rub fastness (crocking)**: Rub dyed fabric against white undyed cloth. Transfer indicates poor bonding — re-mordant and re-dye.
