...
> **Domain**: [Metals](./)
> **Dependencies**: `chemistry.electrolysis`, `chemistry.alkalis`, `energy.electricity`, `mining`
...
- **Agglomeration phase** (first 6-8 hours): Fine seed particles agglomerate into larger clusters. **Growth phase** (20-40 hours): Al(OH)₃ crystallizes on agglomerate surfaces. Total precipitation time: 30-60 hours.
...
**Prebaked anodes** (dominant technology, ~90% of production):
...
**Söderberg anodes** (self-baking, older technology):
...
**Alloy designation system** (AA — Aluminum Association):
...
**Heat treatment tempers** (for heat-treatable alloys — 2xxx, 6xxx, 7xxx):
...
- Molten aluminum forced into steel die at 20-100 MPa. Two types: **hot chamber** (limited to lower-melting alloys, rarely used for aluminum due to attack on gooseneck components) and **cold chamber** (molten Al ladled into shot sleeve, then injected — standard for aluminum).
...
**Direct chill (DC) casting** (for wrought products — ingots for rolling/extrusion):
