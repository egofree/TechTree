...
| Equipment/Resource | Primary Material | Quantity per Unit | Secondary Materials | Source |
|-------------------|-----------------|-------------------|---------------------|--------|
| Battering ram (basic) | Oak/ash beam | 6-10 m x 30-50 cm dia (200-500 kg) | Iron cap 5-10 kg, rope suspension | [Foundations](../foundations/index.md) |
| Covered ram (testudo) | Timber frame + planks | 1000-2000 kg total | Rawhide facing, iron fittings, 4-6 wheels | [Foundations](../foundations/index.md) |
| Siege tower (medium) | Oak/pine timber | 5000-15,000 kg total | Rawhide/metal facing, iron fittings, rope | [Foundations](../foundations/index.md) |
| Trebuchet (medium) | Oak/elm timber | 5-10 m3 timber for frame | 8-tonne stone counterweight, 200 m rope | [Textiles](../textiles/index.md) |
| Cannon (cast bronze, 150 mm) | Bronze (88-92% Cu, 8-12% Sn) | 1000-3000 kg bronze | Carriage timber, iron fittings | [Non-Ferrous Metals](../metals/index.md) |
...
**Covered ram (testudo/turtle)**: Wooden shed on wheels protecting ram crew from missiles and boiling liquids dropped from walls. Shed dimensions: 4-6 m long x 2.5-3.0 m wide x 2.0-2.5 m high. Shed roof: layered construction -- planks + rawhide + earth (50-100 mm) for fire resistance and missile protection. Covered by fresh animal hides during approach to resist incendiary attack. Weight: 1000-2000 kg total (structure + ram). Moved on 4-6 wheels by 20-40 men pushing from inside.
...
**Materials**: Timber frame (oak or pine), plank siding, rawhide or metal sheet facing for fire resistance. Wheels: 4-6 heavy spoked wheels, 50-80 cm diameter, iron-tired axles. Assembly time: 2-6 weeks with 50-100 workers (prefabricated in sections near siege site, assembled under cover of siege screens).

**Approach**: Tower pushed toward wall on prepared ramp of compacted earth (to level ground and reduce approach distance). Ramp construction: 10-20 m wide, 2-5% grade, packed earth -- 5000-15,000 m3 of earth for 100 m approach at 3 m height. During approach, defenders target tower with incendiary projectiles (Greek fire, burning pitch). Counter-counter: fire-resistant cladding, wet hides, assault archers suppressing wall defenders.
...
**Ballista**: Two-arm torsion engine (giant crossbow). Two torsion springs (one per arm) drive a pair of arms forward, propelling a bolt or stone along a guided track. Bolt: 60-120 cm, iron or steel head, wooden shaft, 2-5 kg. Stone: 5-30 kg. Range: 200-400 m (bolt), 150-300 m (stone). Accuracy: can hit a man-sized target at 100-150 m with experienced crew and calibrated torsion spring tension.
...
- **Small trebuchet**: 3-tonne counterweight, 6 m beam, 30-50 kg projectile, 100-150 m range.
- **Medium trebuchet**: 8-tonne counterweight, 8 m beam, 80-150 kg projectile, 150-250 m range.
- **Large trebuchet**: 15-tonne counterweight, 10-12 m beam, 100-300 kg projectile, 200-300 m range.

**Projectile types**: Stone (limestone or sandstone, roughly spherical, 30-300 kg -- cheapest, most common). Incendiary: clay pot filled with Greek fire (naphtha + sulfur + quicklime, 5-10 kg -- ignites on impact). Dead animals: biological warfare (fling plague-infected carcasses over walls -- historically documented at sieges).
...
|--------|-----------|-------------------|----------------------|-------------------|-------------------|
| 1300s | 50-100 | 200-1000 | 2-10 | 0.5-3 | 100-200 |
| 1400s | 80-200 | 500-5000 | 5-50 | 2-15 | 200-400 |
...
|--------|----------------------|-----------|-------------|------|-------------------|
| Mangonel (torsion) | 10-50 | 100-300 | 1-2 per 10 min | 8-20 | 1-2 weeks |
| Ballista (bolt) | 2-5 | 200-400 | 2-4 per 10 min | 5-10 | 1-2 weeks |
| Small trebuchet | 30-50 | 100-150 | 1 per 5-10 min | 12-20 | 2 weeks |
| Medium trebuchet | 80-150 | 150-250 | 1 per 10 min | 20-35 | 3 weeks |
| Large trebuchet | 100-300 | 200-300 | 1 per 15 min | 30-50 | 4 weeks |
| Cannon (100 mm) | 4-10 | 300-600 | 6-12 per hour | 6-10 | N/A (industrial) |
...
|-------|----------|---------------|-------------------|
| Investment | 1-7 days | Surround fortress, cut supply, build siege camp | 5000-20000 soldiers |
| Approach works | 2-8 weeks | Dig approach trenches, build batteries, construct siege engines | 1000-5000 laborers, timber, tools |
| Bombardment | 1-6 weeks | Cannon fire to breach walls, mining under foundations | 10-50 cannon, 5000-20000 shot, 10000-50000 kg powder |
...
|----------|--------------------|---------------------------|------------------------|
| Grain/flour | 1.0-1.5 kg | 1000-1500 kg | -- |
| Water (drinking) | 4-5 L | 4000-5000 L | 6000-8000 L |
| Firewood | 1-2 kg | 1000-2000 kg | -- |
| Ammunition (firearms) | 60 rounds | 180 g powder + 2 kg lead x 1000 | -- |
...
**Fire-setting for tunnel excavation**: Build fire at tunnel face to heat rock, then dash with cold water (or vinegar) -> thermal shock fractures stone. Fumes require ventilation: bellows-driven air through timber-lined ventilation shaft. Tunnel advance rate: 0.5-2.0 m per day (depending on rock hardness).
...
**Ventilation**: Single-entry tunnel fills with CO2 (heavier than air, pools at floor) and exhaled breath. Bellows-driven ventilation through wooden or clay pipe (10-15 cm diameter). Fresh air pumped in from surface, stale air forced out through pipe to tunnel face. Fire-setting accelerates ventilation need -- combustion gases (CO, CO2, SO2) are immediately lethal in confined space.
...
- Firewood: 1-2 kg (cooking, warmth)
- Ammunition (firearms era): 60 rounds (180 g powder + 2 kg lead)
- Fodder (per horse): 5-10 kg hay + 2-5 kg grain + 30-40 L water

**Baggage train**: 1000-soldier force with 200 horses requires daily:
- 1000-1500 kg grain, 4000-5000 L water, 1000-2000 kg firewood for soldiers
- 1000-2000 kg hay + 400-1000 kg grain + 6000-8000 L water for horses
- Total daily requirement: 3-6 tonnes food + 10,000-13,000 L water
- Transport: 20-40 wagons (each 500-1000 kg payload) or 100-200 pack animals per day's supply

**March rate**: Infantry: 15-25 km/day on roads, 8-15 km/day cross-country. Cavalry: 25-40 km/day. Baggage train: 15-20 km/day (limits entire army pace). Maximum effective campaign radius from supply base: 200-300 km (10-15 days march out, retain sufficient supplies for return).
...
|---------|---------------|----------|
| Trebuchet shots falling short | Counterweight insufficient, sling release too early | Add mass to counterweight; adjust sling release pin angle for later release |
| Cannon barrel bursts | Over-charge, barrel flaw, or welded seam failure | Reduce powder charge to rated load; use cast bronze barrels for reliability; inspect bores for cracks |
| Siege tower catches fire | Incendiary attack from defenders | Wet hide cladding maintained throughout approach; suppress wall defenders with covering fire |
| Mine tunnel collapses prematurely | Inadequate shoring, unstable soil | Increase pit prop spacing to 0.5 m; add side boards in loose soil; don't excavate beyond shored section |
| Cannon accuracy poor | Bore erosion, inconsistent powder charge, unlevel platform | Replace eroded barrels; weigh powder charges individually; ensure platform is level and stable |
| Torsion spring loses tension | Humidity/rain softens sinew ropes | Keep torsion springs covered with waxed canvas; replace damaged ropes before engagement |
| Battering ram ineffective against stone wall | Wall too thick (>1.5 m), well-mortared | Redirect to gate; combine with mining under wall foundation; use cannon instead |
| Approach trench takes excessive casualties | Defenders have flanking fire into trench | Zigzag trench alignment; construct head cover (timber + earth parapet); suppress flanking positions with cannon |
...
- **Gunpowder handling in magazine**: A single spark in a powder magazine destroys the entire installation and kills everyone within 50 m. Enforce no-smoking, no-metal-tools, no-naked-flame rules absolutely. Use wooden mauls and copper-tipped implements. Store powder in individual barrels on raised platforms. Lightning strikes on powder magazines have destroyed forts -- install lightning protection (iron rod grounded to earth).
- **Mining asphyxiation**: Tunnel mining produces CO2 (from exhaled breath and fire-setting) and CO (from fire-setting combustion). Both are lethal in confined spaces. CO is odorless and causes unconsciousness without warning. Ventilate all tunnels with bellows. Withdraw miners immediately if anyone feels dizzy or drowsy. Rescue attempts in gas-filled tunnels frequently produce additional casualties.
- **Tunnel collapse**: Mine galleries are inherently unstable. Timber shoring must be installed before any excavation. Never work ahead of the shoring. Collapse can occur without warning in loose soil. Minimum two exits from any tunnel system.
- **Hot shot handling**: Heated cannonballs can ignite powder charges prematurely. Always place a wet wad between powder charge and hot shot. Use iron tongs -- the ball is at 600-800 degrees C. Dropping a hot shot onto dry ground near powder is catastrophic.
- **Siege engine counterweight failure**: Trebuchet counterweights (5-15 tonnes) can crush anyone beneath them if the supporting structure fails. Inspect timber frame for cracks before each shot. Clear all personnel from the counterweight arc. Never stand behind the counterweight during firing.
...
- **[Transport & Logistics](../transport/index.md)** -- Road construction, wagons, railways for military supply
- **[Mining Engineering](../mining/index.md)** -- Tunneling techniques for siege mining
- **[Textiles: Rope](../textiles/index.md)** -- Rope for trebuchet slings, torsion springs, and hoisting
