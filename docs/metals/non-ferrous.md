...
**Ores**:
- **[Sphalerite](../glossary/sphalerite.html)** (ZnS, zinc blende): The dominant ore (~95% of primary production). Often found with galena (PbS) in hydrothermal veins. Color varies from yellow-brown to black depending on iron content — high-iron varieties are called "marmatite." Typical ore grade: 3-12% Zn.
- **[Smithsonite](../glossary/smithsonite.html)** (ZnCO₃) and **[hemimorphite](../glossary/hemimorphite.html)** (Zn₄Si₂O₇(OH)₂·H₂O): Oxide/carbonate ores, historically important ("calamine"), now largely depleted. Easier to reduce than sulfides but rare in economic concentrations.
...
**[Pyrometallurgical extraction](../glossary/pyrometallurgical-extraction.html)** (Imperial Smelting Process):
...
**[Electrolytic extraction](../glossary/electrolytic-extraction.html)** (roast-leach-electrowin, ~80% of production):
...
**Applications**:
- **[Galvanizing](../glossary/galvanizing.html)** (50%): Hot-dip zinc coating on steel (see [Iron & Steel](iron-steel.md)). Coating thickness 45-85 μm. Atmospheric corrosion protection: 20-100+ years depending on environment.
- **[Die-casting alloys](../glossary/die-casting-alloys.html)** (15%): Zamak (Zn-4Al-1Cu-0.05Mg). Melts at 380°C, excellent fluidity, dimensional accuracy ±0.05 mm. Used for automotive components, hardware, toys. Limited to <150°C service temperature.
- **[Brass](../glossary/brass.html)** (15%): Cu-Zn alloy (see [Copper & Bronze](copper-bronze.md)). Zinc as alloying element.
...
**Ores**:
- **[Galena](../glossary/galena.html)** (PbS): The primary ore. Lead-gray metallic luster, cubic cleavage. Often carries silver (0.01-0.5% Ag) — historically the main source of silver. Ore grade: 3-8% Pb in vein deposits; lower in Mississippi Valley-type deposits.
- **[Cerussite](../glossary/cerussite.html)** (PbCO₃) and **[anglesite](../glossary/anglesite.html)** (PbSO₄): Oxidation-zone minerals, secondary after galena.
...
- **[Sintering and blast furnace](../glossary/sintering-and-blast-furnace.html)** (traditional): PbS concentrate is sintered on a Dwight-Lloyd sinter machine — roasted to PbO while agglomerating fines into porous lumps. Sinter + coke + fluxes (limestone, silica) charged into a blast furnace. PbO + CO → Pb + CO₂ at 1000-1200°C. Molten lead (Tm 327°C) collects in the hearth. Lead bullion: 95-98% Pb with Cu, Sn, As, Sb, Ag, Au impurities.
- **[Direct smelting](../glossary/direct-smelting.html)** (modern, ISASMELT/KIVCET): Oxygen-enriched smelting in a single vessel. Higher SO₂ capture (>95%), lower energy, less plant footprint. Replacing traditional sinter-blast furnace plants.
...
**Ores**:
- **[Sulfide ores](../glossary/sulfide-ores.html)** (~30% of production): Pentlandite ((Fe,Ni)₉S₈) with pyrrhotite (Fe₁₋ₓS) and chalcopyrite (CuFeS₂). Major deposits: Sudbury (Canada), Norilsk (Russia), Kambalda (Australia). Nickel grade: 1-3% Ni. These ores also carry Cu, Co, and platinum-group metals as valuable byproducts.
- **[Laterite ores](../glossary/laterite-ores.html)** (~70% of production): Nickeliferous limonite (Fe-Ni oxides, 1-1.8% Ni) and saprolite (Mg-Ni silicates, 1.5-2.5% Ni). Formed by tropical weathering of ultramafic rocks. Major deposits: Indonesia, Philippines, New Caledonia, Cuba. No valuable byproducts. Higher mining cost, lower grade, but much larger total resources than sulfides.
...
**Applications**:
- **[Stainless steel](../glossary/stainless-steel.html)** (65%): Austenitic grades (304: 18Cr-8Ni, 316: 17Cr-12Ni-2.5Mo). Nickel stabilizes the austenite phase at room temperature, preventing the brittle martensite transformation. See [Iron & Steel](iron-steel.md).
- **[Superalloys](../glossary/superalloys.html)** (10%): Ni-Cr-Co base with Al, Ti, Mo, W, Ta additions. γ' precipitation hardening (Ni₃(Al,Ti)) provides creep resistance at 700-1100°C. Used in gas turbine blades, combustion chambers. Inconel, Hastelloy, Waspaloy.
- **[Electroplating](../glossary/electroplating.html)** (10%): Nickel plating provides hard, corrosion-resistant, bright surface. Undercoat for chromium plating. Watts bath: NiSO₄ + NiCl₂ + H₃BO₃ at 45-65°C, pH 3.5-4.5.
...
**Raw materials**:
- **[Dolomite](../glossary/dolomite.html)** (CaCO₃·MgCO₃): Widely available sedimentary rock. Calcine at 1100-1200°C to produce CaO·MgO (doloma).
...
- **[Magnesite](../glossary/magnesite.html)** (MgCO₃): Direct calcination to MgO.

**[Pidgeon process](../glossary/pidgeon-process.html)** (silicothermic reduction, dominant in China — ~85% of world production):
...
**[Electrolytic process](../glossary/electrolytic-process.html)** (ISF/Dow process):
...
**Applications**:
- **[Die casting](../glossary/die-casting.html)** (35%): Mg-Al-Zn alloys (AZ91: Mg-9Al-0.7Zn, AM60: Mg-6Al-0.3Mn). Automotive: instrument panels, seat frames, steering wheels. Electronics: laptop frames, camera bodies. Extremely thin-wall casting possible (0.5 mm).
- **[Aluminum alloying](../glossary/aluminum-alloying.html)** (30%): Mg added to Al (0.5-5%) increases strength, weldability, and corrosion resistance. 5000-series (Al-Mg) and 6000-series (Al-Mg-Si) alloys. See [Aluminum](aluminum.md).
- **[Sacrificial anodes](../glossary/sacrificial-anodes.html)** (10%): Higher driving voltage than zinc anodes. Used for buried pipelines, hot water tanks, marine hulls. Consumed at ~4-8 kg/year per ampere of protection current.
...
**Ores**:
- **[Ilmenite](../glossary/ilmenite.html)** (FeTiO₃): The primary titanium ore. Black, heavy (SG 4.5-5.0). Beach sand deposits (India, Australia, South Africa) and hard-rock deposits (Norway, Canada). TiO₂ content: 45-65%. Also mined for titanium dioxide pigment.
- **[Rutile](../glossary/rutile.html)** (TiO₂): Higher grade (93-96% TiO₂) but rarer. Found as beach sand concentrates. Preferred feedstock for titanium metal due to lower impurity removal cost.
...
**[Kroll process](../glossary/kroll-process.html)** (virtually all primary titanium metal):
...
- **[Ti-6Al-4V](../glossary/ti-6al-4v.html)** (Grade 5, "workhorse alloy" — 50% of titanium consumption): 900-950 MPa UTS, 830-880 MPa yield, 10-14% elongation, 4.43 g/cm³. α+β alloy — aluminum stabilizes α phase, vanadium stabilizes β phase. Used in annealed or solution-treated-and-aged condition.
...
**Applications**:
- **[Aerospace](../glossary/aerospace.html)** (50% of mill products): Airframe components (landing gear, wing structures, engine pylons), jet engine compressor blades and disks. Ti-6Al-4V and Ti-6Al-2Sn-4Zr-2Mo (high-temperature creep resistance up to 540°C).
- **[Medical implants](../glossary/medical-implants.html)** (10%): Hip and knee replacements, bone plates, dental implants, pacemaker housings. Commercially pure Ti (Grades 1-4) and Ti-6Al-4V ELI (extra-low interstitial — reduced O₂ for improved fracture toughness).
...
- **[Pigment](../glossary/pigments.html)** (TiO₂, not metal but 95% of titanium ore consumption): White pigment in paint, plastics, paper. Produced by chloride process (TiCl₄ oxidation) or sulfate process (TiO₂ dissolution in H₂SO₄). This is a separate industry from titanium metal — orders of magnitude larger.
...
2. **[Zinc](../glossary/zinc.html)** (Years 18-25): Roast-leach-electrowin requires sulfuric acid and electrochemistry. Enables galvanizing and brass.
3. **[Nickel](../glossary/nickel.html)** (Years 20-30): Sulfide smelting is straightforward but laterite processing requires HPAL or electric furnaces. Enables stainless steel and superalloys.
4. **[Magnesium](../glossary/magnesium.html)** (Years 25-35): Pidgeon process requires ferrosilicon and vacuum capability. Electrolytic route requires large DC power.
5. **[Titanium](../glossary/titanium.html)** (Years 30-40): Kroll process demands chlorine chemistry, magnesium production, argon supply, and vacuum distillation. The capstone non-ferrous metal.
