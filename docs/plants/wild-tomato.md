...
> **Node ID**: plants.edible-plants.wild-tomato
...
- Species identification: A tomato plant with small round fruit. See Lycopersicum esculentum var. cerasiforme.
...
Within *Solanum lycopersicum var. cerasiforme*, considerable variation exists in yield, disease resistance, climate adaptation, and quality characteristics. When establishing a wild tomato crop, select varieties adapted to local conditions: day length, temperature range, rainfall pattern, and soil type. Landrace varieties — locally adapted populations maintained by traditional farmers — often outperform modern cultivars under low-input conditions because they have been selected for resilience rather than maximum yield under optimal conditions.

Seed saving from the best-performing plants each generation gradually adapts the variety to local conditions. Select for vigor, disease resistance, appropriate maturity timing, and product quality. Maintain genetic diversity by saving seed from multiple plants rather than a single individual, which preserves the population's ability to adapt to changing conditions and disease pressures.

### Crop Rotation and Companion Planting

*Solanum lycopersicum var. cerasiforme* benefits from crop rotation to prevent buildup of species-specific pests and diseases. Avoid planting in the same field in consecutive seasons where possible. Follow with a different crop family to break pest cycles and maintain soil health.

Companion planting with aromatic herbs or flowering plants can deter pests and attract beneficial insects. Avoid planting near species that compete for the same nutrients or harbor shared pathogens.

Tomatoes should not follow other Solanaceae crops (potato, pepper, eggplant) in rotation due to shared soil-borne diseases like Verticillium and Fusarium wilt. Rotate with legumes or brassicas on a 3-4 year cycle. Companion plant with basil (repels aphids and whitefly), marigold (deters nematodes), and carrots (breaks pest cycles). Avoid planting near walnut trees (juglone toxicity).
