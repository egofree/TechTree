...
Simple, effective, breathable. Construct from untreated timber (pine, oak, or any available hardwood). Do not use treated lumber (copper-chrome-arsenate or other preservatives are toxic to worms).
...
Permanent, durable, vermin-proof. Cast in place or built from concrete blocks.
...
A vertical system where worms migrate upward through successive trays of fresh material, leaving finished castings below. Allows continuous harvesting without separating worms from castings by hand.
...
**Commercial examples**: Can-O-Worms (3-tray, plastic), Worm Factory (4-5 tray, plastic). The principle is simple enough to replicate in wood — stack shallow wooden boxes with hardware cloth (wire mesh, 6 mm openings) bottoms.
...
- Fruit and vegetable scraps (chopped for faster processing)
- Coffee grounds and tea leaves
- Cooked rice and pasta (in moderation)
- Crushed eggshells (calcium source, helps buffer pH)
- Aged manure (horse, cow, rabbit)
- Garden trimmings (soft, green material)
- Shredded newspaper and cardboard

**Acceptable** (in moderation):
- Citrus peels (1-2 pieces per feeding; excessive citrus lowers pH and contains d-limonene)
- Onion and garlic (moderate amounts tolerated)
- Bread and grain products (can attract pests if over-fed)
- Yard leaves (avoid walnut — contains juglone, toxic to worms)

**Avoid**:
- Meat, fish, poultry (attracts rats, flies; creates odor and anaerobic conditions)
- Dairy products (oils coat worms, interfering with respiration; odor problems)
- Oils, fats, grease (same as dairy)
- Pet waste (dog, cat feces — pathogen risk)
- Diseased plant material (some pathogens survive vermicomposting temperatures)
...
**Technique**: Bury food in pockets or trenches within the bedding, 5-10 cm below the surface. Cover with bedding to exclude light and prevent fly access. Rotate feeding locations around the bin — place food in a different section each time. This prevents buildup of decomposing material in one spot and distributes worm activity evenly.

**Pre-freezing or chopping**: Freezing food waste (where freezer capacity exists) breaks cell walls and speeds decomposition. Chopping into pieces under 5 cm accelerates processing by increasing surface area.

### Stocking and Reproduction

**Initial stocking**: 1 kg of worms per 0.5 m² of surface area. A 1 × 2 m bin (2 m² surface area) starts with 4 kg of worms (approximately 4000 individuals — roughly 1000 worms per kg for *E. fetida*).
...
**Reproduction rate**:
Under optimal conditions (20-25°C, adequate food, correct moisture), *E. fetida* doubles in population every 2-3 months. Each worm is hermaphroditic (possesses both male and female reproductive organs) but requires a partner for mating.
...
#### Tray Migration (for stacked tray systems)

When the top tray is full and worms have migrated into it, remove the bottom tray (finished castings, nearly worm-free). Place the empty tray on top with fresh bedding and food. Worms naturally migrate upward toward fresh food.
...
### Vermicompost Analysis and Use

**Vermicompost (worm castings) nutrient analysis**:
- Nitrogen: 1.5-2.5% (predominantly in plant-available nitrate form)
- Phosphorus: 1.0-1.5% (solubilized by microbial action in worm gut)
- Potassium: 1.0-1.5%
- Calcium: 2-4% (from ingested soil and eggshells)
- Magnesium: 0.2-0.5%
- Iron: 0.1-0.3%
- Humic acids: 2-5% (stimulate root growth and nutrient uptake)
- Plant growth hormones: auxins, cytokinins, gibberellins (produced by microorganisms in worm gut)
...
**Application rates**:
- Soil amendment: Mix 10-20% vermicompost into potting soil or seed-starting mix.
- Top-dressing: Apply 0.5-1 cm layer around established plants. Water in.
- Transplant: Add a handful of castings to each planting hole before setting seedlings.
- Seed starting: 20-30% vermicompost in seed-starting mix improves germination rate and seedling vigor.
...
**Non-aerated tea** (simpler but lower quality):
Steep vermicompost in water for 7-14 days without aeration. Stir daily. Less microbially diverse than aerated tea and may contain anaerobic organisms. Adequate as a nutrient tea but less effective for disease suppression.

### Environmental Management

#### Temperature

**Optimal range**: 15-25°C for *E. fetida*. Growth and processing rate peak at 20-25°C.
...
**Optimal**: 70-80% moisture content. The bedding should feel like a wrung-out sponge. Squeeze test: compress a handful firmly — 1-2 drops of water should fall. If no drops, the bin is too dry. If water streams out, the bin is too wet.
