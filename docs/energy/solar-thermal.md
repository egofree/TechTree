...
- **Receiver tube surfaces**: Parabolic trough receiver tubes reach 300-500°C. Central receiver surfaces exceed 800°C. Direct contact causes third-degree burns in under 1 second. A stainless steel surface at 400°C produces instantaneous deep tissue burns — skin contact temperature threshold for third-degree burns is 70°C for 2 seconds or 60°C for 5 seconds. Install radiation shields and barriers around receiver assemblies. Post temperature warning signs. Use infrared thermometer to verify surfaces are below 50°C before touching.
- **Concentrated solar flux**: Reflected sunlight from heliostats or dish concentrators produces flux densities of 200-1,000 kW/m² — equivalent to 200-1,000 suns. This intensity ignites cotton clothing in under 5 seconds and causes instantaneous retinal damage (solar retinitis) from even brief direct viewing. At 500 kW/m², the focused beam can melt aluminum (660°C) within seconds. Never look directly at the receiver from within the mirror field — use welder's goggles (shade 8-14) for viewing. Workers in heliostat fields must wear UV-protective clothing and avoid standing in reflected beam paths. Establish exclusion zones around the focal point with physical barriers.
- **Heat transfer fluid**: Mineral oil at 300°C causes full-thickness burns on contact. Molten salt at 565°C is a crystalline solid at room temperature but flows like water when heated. A salt spill of just 10 kg at 565°C carries ~5 MJ of thermal energy — enough to cause severe burns at 3 m distance from the initial splash. The salt solidifies into a hard crust that can trap and continue heating underlying material, making burns worse over time as the salt slowly transfers its stored heat. Use full-face shield, heat-resistant gloves (rated to 500°C minimum — standard leather gloves are not adequate), and body protection when handling hot salt systems. Spill containment: concrete berms 300 mm high around salt tanks, sized for 110% of tank volume.

### Glass Hazards

- **Evacuated tube implosion**: Evacuated glass tubes (80 mm OD, ~1.5 mm wall thickness) are under 1 atm external pressure with vacuum inside. The stored strain energy from atmospheric compression means a tube break produces an implosion followed by scatter of glass fragments at 10-30 m/s. At this velocity, a glass shard penetrates skin and eye tissue easily. Wear safety glasses AND face shield when handling evacuated tubes. Wrap tubes in protective film or netting to contain fragments if breakage occurs. Replace tubes one at a time — never stack or lean evacuated tubes against each other without protective packaging.

### Structural Hazards

- **Wind loading**: Parabolic troughs and heliostats present large sail areas to the wind. At 25 m/s wind speed, a 10 m² heliostat experiences ~3,000 N of force (roughly 300 kg equivalent). A 50 m² heliostat at 35 m/s (hurricane gust) sees ~15,000 N — enough to tear inadequately anchored mounts from foundations. Design mounting structures for local maximum wind loads with a 1.5× safety factor. Stow mirrors face-down (horizontal) when wind exceeds design speed (typically 20-25 m/s for troughs, 15-20 m/s for heliostats).
- **Thermal expansion**: Steel receiver tubes expand ~12 mm per 10 m length per 100°C temperature rise (coefficient of thermal expansion for steel: 12 × 10⁻⁶/°C). A 6 m receiver tube heated from 20°C to 400°C grows 6 m × 12 × 10⁻⁶ × 380 = 27 mm. Provide expansion loops or bellows in piping. Rigidly constrained pipes will buckle and crack — a locked expansion joint on a 6 m tube at 400°C generates ~200 kN of force, enough to shear bolt flanges.
