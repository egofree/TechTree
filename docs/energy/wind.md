...
- **Height hazards**: Windmill towers require climbing for maintenance. A 12 m tower mill has an internal ladder with 30-40 rungs. Fall from >3 m onto hard ground is frequently fatal. Install rest platforms every 5-6 m with handrails. Use a safety harness attached to a fixed lifeline when climbing. Never climb in icy conditions, wind above 12 m/s, or electrical storms.
- **Rotating machinery entanglement**: The windshaft, brake wheel, wallower, and upright shaft all move with enough force to crush or sever limbs. The brake wheel rim moves at 1-3 m/s (linear speed at the rim) — slow enough to seem safe but fast enough to catch loose clothing. Guard all rotating components with wooden or iron enclosures. Disconnect or brake the mill before any maintenance inside the tower. A stone nut engaged with the upright shaft can catch a sleeve and pull an arm into the gear mesh in under 1 second.
- **Lightning**: Tall windmill towers (10-15 m) attract lightning strikes, especially in open terrain. A direct lightning strike carries 20,000-200,000 amps and can ignite wooden towers or destroy iron windshafts. Ground the windshaft and tower structure with a copper conductor (minimum 35 mm² cross-section) connected to a ground rod driven 2-3 m into soil (target resistance <25 ohms). Do not approach the mill during electrical storms.
- **Dust and grain hazards**: Grain milling generates fine organic dust that is both a respiratory irritant and an explosion hazard. Flour dust concentrations above 50 g/m³ in enclosed spaces can detonate with an ignition source (spark from a stone, static discharge). Ventilate the millstone floor. Do not allow dust to accumulate. Wear a dust mask when milling. Install a grounded copper strip on the millstone casing to dissipate static.
- **Sail throwing ice**: In freezing conditions, ice builds up on sail frames. When the mill rotates, centrifugal force throws ice fragments at high velocity (up to 15-25 m/s tip speed). Do not stand within 50 m of an operating windmill in freezing conditions. Ice also alters sail balance, causing vibration — reduce operating speed or shut down during icing events.
...
|---|---|---|
| Power output 30-50% below expected for wind speed | Sail angle of attack incorrect — too flat (not catching enough wind) or too steep (stalling) | Adjust sail angle to 5-15° relative to the plane of rotation. At 7 m/s wind, a 15° angle of attack with Cp 0.25 on a 12 m diameter post mill should produce ~2 HP. If producing <1 HP, increase sail camber by tightening canvas belly ropes or adjust spring tension on shutter-type sails |
| Power output 30-50% below expected for wind speed | Hub height too low — wind shear reducing available wind speed | Measure wind speed at hub height with anemometer. Compare to wind survey data. Each meter of additional height gains ~0.1-0.2 m/s. A post mill at 6 m hub height in a 5 m/s (10 m height) region receives only ~4.5 m/s — losing (4.5/5)³ = 73% of the power available at 10 m. Raise tower or relocate to higher ground |
| Excessive vibration or rumbling (low-frequency) | Sail imbalance — one sail heavier or at a different angle than the others | Weigh each sail frame and match within ±2%. Verify all sail angles are equal within ±1° using a bevel gauge. Even a 5% weight difference on a 10 m sail at 20 RPM produces a cyclic force of ~500 N, which fatigues the windshaft within months |
| Excessive vibration or rumbling (high-frequency) | Main shaft bearing wear or gear tooth damage | Inspect thrust bearing (bottom of upright shaft) for scoring. Check brake wheel teeth for cracking — wooden teeth should be replaced when wear exceeds 30% of face width. Measure shaft runout with dial indicator — runout >0.5 mm indicates bent windshaft |
| Yaw mechanism stuck (cap not facing wind) | Rust or mechanical seizure in turntable rollers or curb ring | The cap rotates on the curb ring via wooden or iron rollers 80-150 mm diameter. Apply tallow or heavy grease to the curb track. Free any seized rollers. For post mills, check that the tail pole pivot is not binding. The force to yaw the cap should be manageable by one person with a 3 m tail pole (~150 N effort). If it requires more, the curb is binding |
| Sail frame cracking at spar-to-sail-bar joints | Fatigue from cyclic wind loading — each rotation reverses the bending stress on the spar | Typical spar life is 5-15 years. Inspect spars annually at mortise joints (weakest point). Replace cracked spars with new stock — do not attempt to splice or sister a cracked spar, as the repair will fail under cyclic loading. Reduce operating speed in gusty conditions (apply brake at wind speeds >14 m/s) to extend spar life |
| Mill stops turning in moderate wind (5-8 m/s) | Brake dragging, or stone(s) engaged but grain feed blocked | Verify brake is fully released (brake blocks not touching the brake wheel rim). Check that each stone nut is either engaged with grain flowing or fully disengaged. A stone pair running dry (no grain) develops friction that stalls the mill in moderate wind. Test by disengaging all stones — if the sails spin freely, the problem is in the stone feed |
| Generator overheating (for electricity-producing mills) | Sustained wind at 10-14 m/s overloading generator above rated capacity | Install overspeed protection: feathering mechanism, mechanical brake, or furling tail vane. For a 10 kW generator on a 12 m rotor, the cut-out wind speed should be set at 14 m/s. Verify brake band contact area is adequate: at least 200 cm² of brake lining per kW of rated power for reliable stopping |
| Tower base rotting (post mill) or cracking (tower mill) | Moisture accumulation at the ground-level structural joint | For post mills: inspect the main post base quarterly. The quarter-bar joints where the cross-trees meet the post are the rot-critical points. Apply tar or paint to all below-knee joints. For tower mills: check mortar joints at the base course for spalling from freeze-thaw cycles. Repoint with lime mortar before winter. A 0.3 m crack in the base wall of a 10 m tower reduces structural margin by ~40% |
| Sails stripping in storms | Furling mechanism failed or was not deployed in time, or spring/patent shutters corroded shut | The critical wind speed for sail failure is ~20-25 m/s (storm force 9) with sails fully exposed. Spring/patent shutters should auto-open at 15-18 m/s. Test shutter mechanism monthly by manually pushing each shutter open — they should move freely under spring tension. Replace corroded springs. For cloth sails, the miller must reef or furl before wind exceeds 12-14 m/s. If caught by a sudden storm, apply full brake and keep it applied until wind subsides. Do not attempt to furl sails in a storm — the forces are too great |
...
- [Redox Flow Batteries](redox-flow-battery.md) — medium-duration grid storage
