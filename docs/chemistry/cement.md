...
|---------|---------------|----------|
| Clinker free lime (CaO) content above 2% — expansion risk in concrete | Kiln burning zone temperature below 1450°C, or raw meal CaCO₃ content too high (above 67% CaO) for available SiO₂/Al₂O₃ to react | Raise burning zone temperature to 1400-1500°C; verify raw mix proportioning targets 65% CaO, 21% SiO₂, 6% Al₂O₃, 3% Fe₂O₃; check Le Chatelier expansion test stays below 10 mm |
| Concrete flash set (stiffens within minutes, unworkable) | Insufficient gypsum (below 2-5%) interground with clinker, or C₃A content above 12% in clinker consuming gypsum too rapidly | Verify gypsum addition is 2-5% by weight during finish grinding; check clinker C₃A content (target 8-12%); increase gypsum to upper end of range (5%) if C₃A is high; test Vicat initial set is >45 minutes per EN 197-1 |
| 28-day compressive strength below design (e.g., <25 MPa for CEM I 42.5) | Water-cement ratio above 0.55 for structural work; insufficient curing (drying before 7 days); or clinker C₃S content below 45% | Reduce water-cement ratio to 0.45-0.55; ensure moist curing for minimum 7 days (wet burlap, ponding, or plastic sheet); verify clinker alite (C₃S) is 45-65%; test at 7 days — expect 65-70% of 28-day strength |
| Thermal cracking in mass concrete pour (dams, foundations) | Heat of hydration (350-500 kJ/kg for Type I) raising internal temperature 50-70°C above ambient, causing thermal gradient stress | Switch to low-heat cement (Type IV: high C₂S, low C₃S/C₃A, 250-350 kJ/kg); use pozzolan replacement (15-40% fly ash); cool aggregate with ice water; install embedded cooling pipes; limit pour thickness |
| Lime mortar not setting after weeks | CO₂ unavailable for carbonation (thick wall interior, enclosed space) or lime was over-slaked and lost reactivity | Use pozzolanic cement (lime + volcanic ash or calcined clay) for hydraulic set independent of CO₂; increase ventilation; verify Ca(OH)₂ was stored dry before use — slaked lime left exposed to air pre-carbonates |
| Kiln thermal energy consumption above 5 GJ/tonne clinker | Wet process in use (30-40% moisture evaporating in kiln) or preheater cyclones fouled reducing heat recovery | Convert to dry process with 4-6 stage cyclone preheater (3.0-3.5 GJ/t); install precalciner to shift 60-90% of calcination out of kiln; clean preheater cyclones; verify kiln exhaust heat is preheating raw meal to 800-900°C |
| Alkali-silica reaction (ASR) cracking appearing years after construction | Reactive silica in aggregate combined with high-alkali cement (>0.60% Na₂O equivalent); moisture present to fuel gel expansion | Use low-alkali cement (<0.60% Na₂O equivalent); test aggregates for reactivity (ASTM C1260); replace reactive aggregate if possible; once ASR starts, concrete must be replaced — no remediation exists |
| Concrete surface dusting and low abrasion resistance | Water-cement ratio too high (>0.65); surface dried too quickly during curing (carbonation weakens surface layer); or over-vibration causing segregation (paste rises, aggregate sinks) | Reduce w/c to 0.45-0.55; cure surface properly (keep wet 7+ days); limit vibration to 5-15 seconds per insertion; use surface sealer or curing compound immediately after finishing |
| Delayed ettringite formation (DEF) in steam-cured precast elements | Concrete exposed to temperatures >70°C during early curing, converting ettringite to monosulfoaluminate; reformation causes delayed expansion | Limit steam curing temperature to 60-80°C; if >70°C is required, use sulfate-resistant cement (low C₃A <5%); avoid prolonged steam exposure; verify expansion testing at elevated temperature before production |
| Blaine fineness test showing <300 m²/kg (coarse grind) | Ball mill liner wear reducing grinding efficiency; insufficient grinding time; or clinker too hard (high belite C₂S content) | Replace worn ball mill liners and grinding media; increase grinding time or reduce feed rate; verify finish grinding target is 300-400 m²/kg for OPC; check that 2-5% gypsum is being added during grinding (lubricates grinding and controls set) |
