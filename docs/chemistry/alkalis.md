...
|---------|---------------|----------|
| Solvay carbonation tower NaCl conversion below 72% | Carbonation temperature above 20°C increasing NaHCO₃ solubility, or CO₂ concentration too low from lime kiln | Reduce carbonation temperature to 15-20°C using cooling coils; verify kiln CO₂ gas is 35-40% concentration; check both calciner CO₂ (~70%) and kiln CO₂ are being fed in correct two-stage sequence |
| Solvay NaHCO₃ filter cake high in NH₄Cl contamination | Insufficient cold water washing on rotary vacuum filter; wash water too warm | Increase wash water volume; ensure wash water is cold (<15°C) to prevent NaHCO₃ dissolution; verify filter cake moisture is near 15% — excess moisture carries more NH₄Cl |
| Ammonia recovery still losing >2 kg NH₃ per tonne Na₂CO₃ | Incomplete NH₄Cl decomposition — slaked lime insufficient or steam stripping inadequate in the ammonia distillation column | Increase Ca(OH)₂ feed rate to the ammonia still; raise steam stripping rate; verify Ca(OH)₂ slurry concentration (15-25% solids); check for lime scaling in the still reducing heat transfer |
| Lime-soda causticization conversion below 85% | Reaction temperature below 80°C or initial Na₂CO₃ concentration too high shifting equilibrium | Raise temperature to 80-90°C with steam heating; reduce Na₂CO₃ feed concentration to 10-12%; increase residence time to 1-2 hours with agitation; verify Ca(OH)₂ is fresh (slaked lime loses reactivity over time) |
| NaOH concentration stuck at 50% in steel evaporator | Steel equipment corroded above ~60% NaOH at elevated temperatures; cannot reach 73% or solid grade | Switch to nickel-clad vessels for final concentration stage; evaporate at 400-500°C for solid NaOH flakes; accept 50% solution as standard commercial grade from steel equipment |
| Leblanc black ash furnace producing low Na₂CO₃ yield | Furnace temperature below 900°C preventing complete Na₂SO₄ reduction, or insufficient coke/charcoal reductant | Raise furnace to 900-1000°C; verify carbon charge is 2 mol C per mol Na₂SO₄; extend roast time to 1-2 hours; ensure thorough mixing of Na₂SO₄, CaCO₃, and coke before charging |
| Leblanc CaS waste generating H₂S odor on exposure to rain | Calcium sulfide waste reacting with water releasing toxic H₂S gas | Oxidize CaS waste pile with forced air to convert to CaSO₄ (gypsum) before rain exposure; divert rainwater runoff; use gypsum product for plaster and wallboard |
| Quicklime (CaO) not slaking completely — hard lumps remain | Limestone under-calcined (kiln below 900°C) producing unconverted CaCO₃ cores, or stone pieces >150 mm too large for complete decomposition | Increase kiln calcination zone temperature to 900-1200°C; reduce limestone feed size to 50-150 mm; extend shaft kiln residence time to 12-24 hours; verify 56 kg CaO per 100 kg CaCO₃ yield |
| Potash leachate density below 20° Baumé (~1.16 g/mL) | Insufficient ash-to-water ratio in leaching vat, or conifer wood used (lower K₂CO₃ than hardwood) | Increase ash-to-water contact time; use hardwood ash (oak, beech, maple — 5-15% K₂CO₃) instead of conifer; recycle weak lye through fresh ash beds; verify leachate density with hydrometer before evaporation |
| Lime kiln thermal efficiency below 50% | Excessive fuel consumption or poor heat recovery — preheating zone not recovering exhaust gas heat | Verify shaft kiln has correct temperature gradient (top 400°C preheat, middle 1100°C calcination, bottom 100°C cooling); reduce stone size range to 50-150 mm for uniform gas flow; check for air leaks in kiln shell reducing draft; install or repair cooling zone heat recovery to preheat combustion air |
