...
**Bronze axe**: Socketed axe head, 10-20 cm cutting edge, 200-500 g. Edge angle: 25-35° (compromise between sharpness and durability). Used as both tool and weapon.
...
**Carburized steel blades**: Iron bar packed in charcoal and heated to 900-950°C for 1-4 hours → surface absorbs carbon to 0.3-0.8%, forming steel layer. Forge-welded steel edge to wrought iron back (pattern welding: alternating steel and iron rods forge-welded, twisted, and re-forged produces composite blade with hard edge and flexible back).

**Heat treatment of steel blades**: Critical parameters depend on carbon content:
- **0.3-0.5% carbon**: Heat to cherry red (~780-830°C), quench in water or brine. Temper at 250-350°C for 30-60 minutes. Result: HRC 40-50 (sword blade — tough, resists breaking).
- **0.6-0.8% carbon**: Heat to 750-800°C, quench in warm oil (less thermal shock than water). Temper at 200-280°C. Result: HRC 55-62 (knife edge, axe bit — hard, holds edge).
...
**Crucible steel (Wootz method)**: Iron + carbon (1.0-2.0%) + trace elements (vanadium, chromium from specific ores) sealed in clay crucible, heated to 1300-1400°C for 4-6 hours. Slow cooling produces cementite dendrites in pearlite matrix → characteristic damascene pattern when etched. Hardness: HRC 55-65. Superior to pattern-welded blades — more uniform carbon distribution.
...
**Rifled musket**: Spiral grooves cut into bore interior (3-7 grooves, 1 turn in 100-120 cm) impart spin to elongated bullet. Spin stabilizes projectile in flight → dramatic accuracy improvement. Effective range: 300-500 m aimed (vs 50-80 m smoothbore). Muzzle velocity: 400-500 m/s with Minié ball (hollow-base bullet that expands into rifling on firing). Ammunition: .58 caliber (14.7 mm) Minié ball, 30-35 g, powder charge 50-60 g.
...
| Rifled musket | 33 g Minié ball | 2600-4000 | 300-500 | 2-3/min |
...
**Cutting mechanics**: A blade cuts by concentrating force on a narrow edge. Edge performance depends on edge angle, steel hardness, and blade geometry. Edge angle (included angle): 20-30° for cutting/slicing weapons (swords, knives), 40-60° for chopping weapons (axes). Thinner edge = sharper but more fragile. Harder steel holds thin edge longer but chips more easily. Optimal for sword: edge angle 25-30°, HRC 45-50, with fuller (groove) reducing blade weight 15-20%.
...
**Lead sling bullets (glandes)**: Cast in stone or clay molds, almond-shaped, 30-80 g. Sometimes inscribed with messages ("Take this," "Ouch"). Higher density than stone (11.3 g/cm³ vs 2.5 g/cm³) → smaller projectile, same mass, less air resistance, flatter trajectory. Cast lead bullet production: 100-200 per hour with simple mold.
...
### Firearm Ammunition Detail

**Lead ball manufacture**: Melt lead (327°C melting point) in iron ladle, pour into bullet mold (stone, iron, or brass two-piece mold). Production rate: 30-60 balls per hour per mold. Standard musket ball (.69 caliber): 25-32 g, 17.5 mm diameter. Scrap lead (roofing, pipes, type metal) readily recycled. Lead is toxic — chronic handling causes lead poisoning (colic, neuropathy, death). Wash hands after casting.

**Cartridge paper**: Smooth, strong paper (wrapping paper grade) for making paper cartridges. Cartridge construction: powder charge (15-25 g) + ball wrapped in paper cylinder, tied with thread at both ends. Soldier tears cartridge with teeth, pours priming powder into pan, dumps remaining powder down barrel, ram ball + paper wrapping down barrel as wad. Standardized ammunition: British Brown Bess used .75 caliber, French Charleville .69 caliber — incompatible in emergency.

**Minié ball detail**: Hollow-base conical lead bullet, .58 caliber (14.7 mm), 30-35 g. The hollow base expands into rifling grooves when powder gas pressure forces it into the bore. This allows loading from muzzle (bullet drops in freely, expands on firing) while still engaging rifling for spin stabilization. Manufactured by swaging (pressing lead into die) — faster than casting, more uniform. Production: 200-500 per hour per swaging press.
