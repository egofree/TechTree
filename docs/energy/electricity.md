...
> **Enables**: `agriculture.hydroponic-ph-control`, `chemistry.acid-regeneration`, [`chemistry.air-separation`](../chemistry/air-separation.md), `chemistry.e-methanol`, `chemistry.electrodialysis`, [`chemistry.electrolysis`](../chemistry/electrolysis.md), `chemistry.lithium-separation`, `chemistry.water-electrolysis`, [`computing.electromechanical`](../computing/electromechanical.md), [`construction.industrial-buildings`](../construction/industrial-buildings.md), `cryogenics`, `electrochemistry`, `electronics`, [`electronics.electrical-systems`](../electronics/electrical-systems.md), [`energy.electric-furnaces`](electric-furnaces.md), `energy.electricity.power-systems`, `energy.redox-flow-battery`, [`energy.storage.pumped-hydro`](pumped-hydro.md), [`machine-tools.edm-cnc`](../machine-tools/edm-cnc.md), [`machine-tools.joining`](../machine-tools/joining.md), `machine-tools.joining.electron-beam`, `machine-tools.joining.laser-welding`, `machine-tools.joining.mig-welding`, `machine-tools.joining.resistance-welding`, `machine-tools.joining.tig-welding`, `machine-tools.joining.ultrasonic-bonding`, [`measurement.electrical-instruments`](../measurement/electrical-instruments.md), [`measurement.temperature-pressure`](../measurement/temperature-pressure.md), [`metals.aluminum`](../metals/aluminum.md), `metals.aluminum.semiconductor-grade`, `telecom`, [`telecom.electric-telegraph`](../telecom/electric-telegraph.md), [`telecom.radio`](../telecom/radio.md), [`telecom.telephone`](../telecom/telephone.md), [`transport.telegraph`](../transport/telegraph.md), `vacuum`, `water.desalination`
