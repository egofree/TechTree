...
> **Domain**: [Metals](./)
> **Dependencies**: `metals.steelmaking`, `metals.aluminum`, `machine-tools`
...
2. **Continuous casting** → direct hot rolling. The dominant modern route — 95%+ of world steel production. Eliminates ingot-to-bloom conversion steps, improving yield by 8-12%.
...
**Hot extrusion — aluminum** (the dominant application):
...
**Steel extrusion** (less common, specialized):
...
**Universal mill** (for H-beams and wide-flange sections):
...
**Bar rolling** (round, square, hexagonal, flat):
