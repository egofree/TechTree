...
|---------|---------------|----------|
| Absorption system COP below 0.4 (should be 0.5–0.7) | Generator temperature too low (<80°C) to fully drive ammonia out of 35–40% NH₃ solution; or solution heat exchanger not recovering heat between hot weak and cold strong solution streams | Increase heat source temperature to 120–150°C at the generator. Inspect solution heat exchanger for internal fouling — a fouled exchanger drops heat recovery, forcing the generator to work harder. Verify rectifier column packing (ceramic Raschig rings, 15–25 mm) is not plugged, causing water carryover into the refrigerant circuit |
| Ammonia leak detected by smell (detectable at 5 ppm) | Seal or gasket failure on steel pressure vessel rated to 15 bar; ammonia escaping from generator (10–15 bar), condenser, or absorber connections | Evacuate the space (IDLH = 300 ppm, lethal at 5000+ ppm). Activate emergency ventilation at 30+ air changes/hour. Locate leak with sulfur candle (forms white NH₄Cl smoke at leak point). Isolate and replace failed gasket. Pressure-test repair at 1.5× design pressure before returning to service |
| Ice block center remains unfrozen after 24 hours in can ice system | Brine temperature too warm (>−10°C) or brine specific gravity too low (<1.20) for adequate heat transfer; or agitator not circulating brine at 0.3–0.6 m/s around cans | Check CaCl₂ brine concentration with hydrometer — target 23–28% by weight (SG 1.20–1.26). If dilute, add CaCl₂. Verify agitator motor (0.5–1 kW) is running and propeller is turning freely. Check that evaporator coils are not iced over — defrost if approach temperature exceeds 3–8°C between refrigerant and brine |
| Vapor-compression compressor knocking or vibrating | Liquid refrigerant slugging the compressor (floodback); TXV not maintaining 5–10°C superheat at evaporator outlet, allowing liquid into the suction line | Check superheat at compressor suction: if <5°C, the TXV bulb may be loose on the suction line or the orifice is too large. Secure TXV bulb with good thermal contact to suction line, insulated from ambient. Verify condenser subcooling is 3–5°C — overcharged systems flood the evaporator. Never charge refrigerant as liquid into the suction side |
| Cold storage room temperature rising above −18°C setpoint | Door gaskets leaking (no magnetic/compression seal), or vapor barrier breached allowing moisture infiltration that ices the evaporator coil; or insulation settled (sawdust 200–400 mm settling over time) | Inspect door gaskets — replace if gaps visible with light test at closed door. Check for frost buildup on evaporator coils and defrost if airflow is restricted. Verify vapor barrier continuity on warm side of wall — any breach allows condensation inside the 150–200 mm cork insulation, destroying its R-value. Measure wall thermal conductivity — if U > 0.25 W/m²·K, insulation is compromised |
| Condenser pressure running at >15 bar on ammonia system | Condenser cooling water insufficient; water inlet temperature >30°C or flow rate too low to reject heat at the design condensing temperature of 25–40°C | Measure cooling water inlet and outlet temperatures — target 5–10°C rise. If inlet is >30°C, supplement with cooling tower or increase water flow. Clean condenser tubes if fouled (biological growth, scale). Verify condenser is not air-bound — non-condensable gases (air leaked in on low side) collect at the top and reduce effective heat transfer surface |
| Compressor oil not returning from evaporator (oil logged) | Refrigerant velocity in suction line too low to carry oil back to compressor at part load; oil accumulates in evaporator, starving compressor bearings | Check suction line pipe sizing — may be oversized for actual operating load, reducing gas velocity below the 3–5 m/s minimum for oil entrainment. Install oil separator on discharge line and return oil to crankcase. Verify compressor oil level sight glass — if below minimum, add oil. Avoid running system below 30% of rated capacity for extended periods |
| Brine corrosion damaging steel ice cans and tank | CaCl₂ brine (23–28%) corroding galvanized steel; corrosion inhibitors (sodium chromate or nitrite) depleted below 2000–3000 ppm effective concentration | Test brine inhibitor concentration with chemical test kit; add sodium chromate or nitrite to restore 2000–3000 ppm. Inspect ice cans and tank walls annually — replace heavily corroded cans before they leak water into brine (which dilutes it). Consider applying coal-tar epoxy coating to steel surfaces in contact with brine |
| Evaporator approach temperature exceeding 8°C (spec 3–8°C) | Fouled or iced evaporator tubes reducing heat transfer; or refrigerant charge low causing active evaporator surface area to shrink as coils starve from the inlet end | Measure temperature difference between brine/air leaving the evaporator and the evaporating refrigerant. If >8°C, inspect coils for fouling (clean mechanically or chemically). Check refrigerant sight glass for bubbles — bubbles indicate undercharge. For direct-expansion coils, verify TXV is feeding properly (5–10°C superheat at outlet). Defrost iced coils before resuming operation |
| Cold store floor frost heave cracking the concrete slab | Floor insulation (150–200 mm under slab) inadequate or missing; sub-grade soil freezing and expanding at −18°C room temperature, cracking the slab and heaving the floor | Install heater cables or ventilation ducts under the floor slab to keep sub-grade temperature above 0°C. Verify floor insulation is continuous — even a 1 m² uninsulated section conducts enough heat to freeze the ground below. For existing damage, excavate affected area, install insulation and under-floor heating, and repour the slab section |
