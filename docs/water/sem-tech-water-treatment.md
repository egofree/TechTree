...
|---------|---------------|----------|
| Product water TDS rises above 500 mg/L despite normal voltage | Membrane pinholes or tears — hold membrane to light to see bright spots; or internal leakage from uneven stack compression allowing concentrate-to-diluate cross-flow | Replace damaged membranes; retorque tie rods in cross-pattern to 0.5–2.0 MPa for even compression; replace hardened or cracked spacer gaskets that allow channel bypass |
| Stack resistance increases >20% from baseline at constant current | CaCO₃ or CaSO₄ scaling on membrane surfaces from high-hardness feed water; or organic fouling (humic substances) coating membranes | Circulate 2% HCl solution for 30–60 minutes for scale removal, then 1% NaOH for 30–60 minutes for organic fouling; implement EDR (polarity reversal every 15–30 minutes) to prevent future scaling |
| Water recovery below 75% — brine volume excessive | Concentrate stream flow rate set too high relative to diluate (target 80–120% of diluate flow); or pressure imbalance bowing membranes and reducing effective channel area | Reduce concentrate pump flow to match diluate within 80–120% range; balance hydraulic pressures in both loops to prevent membrane deformation; check for high feed TDS requiring longer residence time |
| Product water pH below 6.5 after ED treatment | Water splitting at electrodes at current density >50 mA/cm² — electrolysis produces acid (anode side) and base (cathode side) contaminating adjacent channels | Reduce current density below 50 mA/cm²; ensure electrode rinse flow is adequate (5–10% of feed flow); dose product water with hydrated lime (Ca(OH)₂) at 30–80 mg/L to restore pH to 7.0–8.0 and add alkalinity |
| Graphite electrodes visibly eroded and pitted after 6 months | Normal wear rate is 1–2 years; excessive current density (>50 mA/cm²) or insufficient electrode rinse flow accelerating oxidation and erosion | Reduce operating current density; verify electrode rinse flow meets specification; schedule electrode replacement during annual maintenance; consider upgrading to coated titanium mesh electrodes for longer life |
| Uneven product water quality between cells — some cells at 200 mg/L TDS, others at 800 mg/L | Manifold blockage restricting flow to specific cells; or spacer mesh compacted in high-pressure zones reducing effective channel area | Flush manifolds with acid solution to clear scale or debris; replace compacted spacers; use consistent torque during reassembly; install air release valves at manifold high points to prevent air locks |
| Free chlorine residual drops below 0.2 mg/L at distribution endpoint | Sodium hypochlorite dose insufficient for organic load in product water; or long residence time in distribution system consuming available chlorine | Increase NaOCl dose to achieve 0.5–1.0 mg/L residual at storage tank after 30-minute contact time; for distribution with long residence, target 0.2–0.5 mg/L at point of use; verify with DPD colorimetric test kit daily |
| Product water turbidity exceeds 5 NTU after post-treatment | Pre-treatment cartridge filter (10 μm) clogged and bypassing; or sand filter media channeled allowing suspended solids through; post-treatment lime dosing adding un-dissolved particles | Replace cartridge filter element monthly or when pressure drop exceeds rated differential; backwash sand filter to eliminate channeling; verify lime is fully dissolved in mixing tank before dosing — install 1-μm final cartridge filter after remineralization |
| Evaporation pond brine level rising instead of evaporating (arid climate) | Pond undersized — net evaporation rate (pan evaporation × 0.7 − rainfall) overestimated; or HDPE liner leak allowing brine to raise groundwater level and reduce effective evaporation | Recalculate pond area using actual local evaporation/rainfall data (net rate = pan evap × 0.7 − rainfall); inspect liner for leaks — 1.0–1.5 mm HDPE should last 20+ years if undamaged; add second pond cell for overflow capacity at 1.5× calculated area |
| Solar charge controller shows ED stack drawing 0 A despite sunshine | MPPT controller not matching solar panel I-V curve to ED stack load; or DC circuit breaker tripped from surge; battery bank voltage below minimum cut-off | Verify MPPT controller is configured for the ED stack voltage range (50–600V DC); check and reset DC-rated circuit breakers; confirm battery bank voltage is above low-voltage disconnect threshold; test solar panel open-circuit voltage matches panel rating |
