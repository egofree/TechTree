...
|---------|---------------|----------|
| Chlor-alkali cell voltage rising above 3.8V per cell | Electrolyte gaps widening from graphite anode consumption (2-5 kg/t Cl₂); or diaphragm clogging from Ca²⁺/Mg²⁺ precipitation; or brine concentration below 25% | Replace consumed graphite anodes or adjust anode-cathode gap; clean or replate asbestos diaphragm; verify brine purification: Na₂CO₃ for CaCO₃, NaOH for Mg(OH)₂, BaCl₂ for BaSO₄ if sulfate >5 g/L; maintain NaCl at 25-26% |
| Chlor-alkali NaOH product contaminated with >15% NaCl (diaphragm cell) | Diaphragm breached or too thin — allowing brine to flow through without proper Na⁺ selectivity; or insufficient evaporation | Redeposit diaphragm by vacuum-drawing fresh asbestos slurry onto cathode screen (6-12 month cycle); verify triple-effect evaporators are crystallizing NaCl from 10-12% NaOH to reach 50% product; check for diaphragm holes or tears |
| Membrane cell Nafion membrane failure (sudden voltage spike or product cross-contamination) | Ca²⁺ or Mg²⁺ in feed brine exceeding 20 ppb, forming insoluble hydroxides within membrane structure; or membrane mechanically damaged | Install or regenerate ion exchange polishing (chelating resin) to reduce Ca²⁺+Mg²⁺ to <0.02 mg/L; replace failed membrane; verify brine purification sequence (Na₂CO₃ → NaOH → BaCO₃ → filter → ion exchange) is operating correctly |
| Aluminum cell anode effect — voltage spiking to 20-40V | Alumina concentration in cryolite bath fell below ~1.5%, triggering gas film formation under anodes; CF₄ and C₂F₆ greenhouse gases evolving | Activate automatic point feeders to dump 1-2 kg alumina per event every 1-5 minutes; verify alumina is α-Al₂O₃ with <0.04% moisture; do not exceed ~8% dissolved alumina (forms frozen sludge); minimize anode effects to keep PFC emissions <0.1 kg CF₄/t Al |
| Aluminum cell cathode cracking — bath leaking to steel shell | Sodium penetration of carbon cathode blocks over 3-8 years causing structural failure; or ramming paste joints degraded | Schedule cathode relining at first sign of shell temperature hot spots; use high-quality prebaked cathode blocks (anthracite + 25-30% coal tar pitch, baked at 1000-1200°C); ensure ramming paste joints are properly compacted during installation |
| Copper electrorefining cathode deposits rough or dendritic (short-circuiting with anodes) | Additive depletion — glue, thiourea, or chloride ions (20-40 mg/L) insufficient to promote smooth dense deposits; or current density above 300 A/m² | Replenish leveling additives (glue + thiourea + Cl⁻ at 20-40 mg/L); reduce current density to 200-300 A/m²; verify electrolyte circulation is 20-30 L/min per tank; check for temperature stratification (maintain 50-65°C) |
| Alkaline water electrolyzer H₂ purity below 99.5% | Trace O₂ contamination from cross-leakage through degraded diaphragm; or KOH mist carryover | Replace or recondition diaphragm (polypropylene or polysulfone fabric); install catalytic recombination unit (Pt catalyst converts trace O₂ + H₂ → H₂O in product stream); verify KOH concentration is 25-30% (specific gravity 1.23-1.28) |
| Hall-Héroult cell metal tapping yields aluminum below 99.5% purity | Bath composition off-spec — excess AlF₃ above 10% or CaF₂ above 5% causing impurity co-deposition; or alumina feed contaminated with SiO₂ or Fe₂O₃ | Verify bath composition: 80-90% cryolite, 5-10% AlF₃, 2-5% CaF₂; test alumina purity before feeding; maintain bath temperature at 960-980°C; tap more frequently (every 24-48 hours) to prevent impurity accumulation |
| Chlorine gas detector alarming in cell room (Cl₂ >10 ppm IDLH) | Cell gasket failure; Cl₂ ductwork leak (titanium or FRP); or H₂ crossover creating pressure imbalance | Activate emergency NaOH scrubber; evacuate cell room (Cl₂ is 2.5× heavier than air — accumulates at floor); find and isolate leaking cell; verify Cl₂ and H₂ gas streams are never mixed (explosive at 4-93% H₂ in Cl₂); repair gaskets or ductwork before restart |
| Bus bar joints overheating (visible heat discoloration, >100°C) | Contact resistance from loose bolted joints or corroded silver-plated surfaces; at 200 kA, even 0.001 Ω dissipates 40 kW | Tighten all bus bar bolted joints to specification; clean and re-silver-plate contact surfaces; verify copper bus bar current density is 1.0-1.5 A/mm²; install thermal monitoring on critical joints; accommodate thermal expansion with flexible connectors |
