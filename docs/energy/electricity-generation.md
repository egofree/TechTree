...
- **Lubrication**: Splash system (rod dips into oil sump, splashes oil onto cylinder walls and bearings) or pressurized (gear pump circulates oil through galleries). Oil: castor oil or mineral oil (see [Lubricants](../lubricants/oils-fluid-mechanics.md)).
...
- **Power output**: 5-65 HP for 1-4 cylinders, 1000-3000 RPM. Power-to-weight ratio is THE critical metric for aircraft (see [Aircraft](../aircraft/development.md)).
...
- Lubrication is critical at every pass (tallow or soap solution; see [Lubricants](../lubricants/oils-fluid-mechanics.md)); without it the wire galls and snaps
...
- **Synthetic rubbers** (nitrile, neoprene) are Chemistry+ materials requiring petrochemical feedstocks from [Petrochemicals](../petrochemicals/petroleum-alternatives.md); see [Polymers](../polymers/overview.md) for the full elastomer development roadmap
