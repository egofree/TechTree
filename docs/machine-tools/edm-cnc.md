...
> **Enables**: [`precision-motion.nanometer-positioning`](../precision-motion/nanometer-positioning.md),
> [`precision-motion.wafer-stages`](../precision-motion/wafer-stages.md)
