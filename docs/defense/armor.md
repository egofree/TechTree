...
**Rawhide armor**: Dried cattle or horse hide, 3-5 mm thick after processing (soak in water, stretch, dry under tension, optional oil treatment for flexibility). Properties: cut resistance ~30% greater than equivalent-thickness textile, puncture resistance moderate. Rawhide硬化 (hardening): boil in water or wax → shrinks, thickens, becomes rigid. Boiled leather (cuir bouilli): heat-formed to body shape, provides rigid plate-like protection at half the weight of bronze. Weight: 3-5 kg for torso cuirass. Stops slashing attacks; punctured by thrusting weapons (spear, arrow) with moderate force.

**Laminar leather armor**: Overlapping horizontal strips of hardened leather (5-8 cm wide × 3-4 mm thick) laced to fabric or leather backing. Provides flexible protection with laminated defense — each strip overlaps the one below by 2-3 cm. Used extensively in ancient Near East, Mesoamerica. Weight: 5-8 kg for full torso and shoulder coverage.
...
- **Great helm** (12th-13th c.): Cylindrical flat-topped helm covering entire head, vision through narrow eye slit (10-20 mm × 80-150 mm). Weight: 2.5-3.5 kg. Excellent protection, terrible visibility and ventilation — worn over mail coif, removed for melee after initial cavalry charge.
...
- **Kite shield** (90-120 cm × 45-60 cm, 4-6 kg): Norman/early medieval. Teardrop shape protects lead leg on horseback.
- **Heater shield** (60-75 cm × 40-50 cm, 3-5 kg): High medieval. Flat-topped, curved bottom. Smaller size for fighting on foot with sword.
- **Pavise** (80-120 cm × 50-80 cm, 5-8 kg): Late medieval. Large rectangular shield for crossbowmen — propped on ground as portable cover while spanning crossbow. Often painted with heraldic device.
...
| Armor Component | Thickness (mm) | Area Coverage (m²) | Weight (kg) | Steel Type |
|----------------|----------------|-------------------|-------------|------------|
...
| Greaves (pair) | 1.0-1.5 | 0.10-0.16 | 1.5-2.5 | Low-C, spring tempered |
