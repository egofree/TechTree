# Distillation & Gas Handling

> **Node ID**: `chemistry.distillation-gas-handling`
> **Also covers**: `chemistry.cement`
> **Domain**: [Chemistry](./)
> **Dependencies**: `foundations.kilns-pottery`, `mining`
> **Enables**: `silicon.purification`, `specialty-gases.air-separation`, `specialty-gases.hydrogen-silane`
> **Timeline**: Years 20-35
> **Outputs**: distillation_capability, gas_handling, compressed_gases, purified_gases, cement, concrete, reinforced_concrete
...
- **Fractional distillation** for petroleum (see [Petrochemicals](../petrochemicals/petroleum-alternatives.md)): Multiple fractions drawn at different heights corresponding to different boiling ranges.
...
- See [Petrochemicals](../petrochemicals/petroleum-alternatives.md) for feedstock production and [Polymers](../polymers/overview.md) for polymerization.
