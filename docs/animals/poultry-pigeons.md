...
- **Carneau**: French squab breed. 550-700 g live weight. Squab reach 400-500 g at 26-30 days. Good foragers if allowed to range. Red, yellow, and white varieties. Hardy and disease-resistant. Slightly less prolific than Kings but excellent meat quality.
- **Mondain**: Large French breed developed for maximum squab size. 700-900 g live weight. Squab can reach 500-600 g dressed. Lower reproduction rate (8-10 squab pairs per year) but premium weight per bird.
- **Texan Pioneer**: Auto-sexing breed (males and females have different feather colors as nestlings, enabling early sorting). Good squab production and rapid growth. 600-750 g live weight.

**Utility and dual-purpose breeds**:
...
**Trap system** (for homing pigeons):
One-way trap doors (bobs) allow pigeons to enter but not exit through the trap hole. This is essential for racing and messaging pigeons — they can return home but cannot leave without the keeper opening an exit. Simple construction: a row of thin metal or wooden rods hung vertically in the entry hole, spaced 4-5 cm apart. Pigeons push through inward but cannot push them outward to escape.
...
- Whole corn (maize): 30-40% (energy source)
- Wheat: 20-30% (energy and protein)
- Peas or vetch: 20-30% (protein)
- Sorghum (milo): 10-15% (energy)
- Small seeds (millet, canary seed): 5-10% (palatability, B vitamins)

Adult pigeons consume 30-50 g of grain per day each when confined, less if allowed to forage freely (feral and free-flight pigeons supplement with weed seeds, spilled grain, and occasional insects).

**Foraging**:
If allowed free flight, pigeons forage over a 2-5 km radius, finding 30-70% of their diet from fields, roadsides, and waste grain. Free-flight loft management dramatically reduces feed costs but exposes birds to predation, weather, and the risk of loss. The foraging instinct is strong — even confined pigeons spend hours pacing and pecking at the aviary floor.

**Crop milk production**:
Both male and female pigeons produce crop milk (a curd-like secretion from the crop lining) during the first 14-18 days after hatching. Crop milk is extremely nutritious: 60% protein, 32-36% fat, 1-2% mineral ash by dry weight — richer than mammal milk. This enables squab to double their hatch weight in just 2 days and reach near-adult weight by 4 weeks. No external feed is required for squab during the first 2 weeks — parents regurgitate crop milk exclusively, then gradually introduce softened grain.
...
Pigeons lay 2 eggs per clutch (usually laid 44-48 hours apart). Incubation: 17 days, shared equally by both parents (cock incubates approximately 10:00-16:00, hen incubates afternoon through morning). Both parents can produce crop milk and feed squab — this shared parental investment is unique among domestic poultry. Eggs are white, weighing 15-20 g each. Pigeon eggs are edible but rarely eaten in squab production because each egg represents significant meat yield potential.

**Reproductive cycle**:
The tight reproductive cycle is a major advantage. Typical timeline:
- Day 0: First egg laid
- Day 2: Second egg laid, incubation begins in earnest
- Day 17-19: Eggs hatch
- Day 17-30: Squab fed by parents (crop milk → mixed crop milk and grain → grain)
- Day 26-30: Squab harvested for meat
- Day 20-25: Parents often begin a new clutch while still feeding squab

This overlapping cycle means a productive pair can be rearing squab in one nest box while incubating eggs in the second. With good management, a pair produces a new clutch every 5-6 weeks.
...
| Property | Pigeon Guano | Chicken Manure | Cow Manure |
|----------|-------------|----------------|------------|
| Nitrogen (%) | 4.0-5.0 | 1.5-2.0 | 0.5-1.0 |
| Phosphorus (%) | 2.0-3.0 | 1.0-1.5 | 0.3-0.5 |
| Potassium (%) | 1.5-2.0 | 0.5-0.8 | 0.5-1.0 |
| Moisture (%) | 30-40 | 60-70 | 80-85 |

**Collection and processing**:
Guano accumulates on the loft floor. Scrape and collect weekly to prevent ammonia buildup. Air-dry in thin layers for 2-3 weeks, or compost with carbon material (straw, leaves) for 2-3 months before garden application. Fresh pigeon guano is too concentrated for direct use — it will burn plant roots. Dilute by composting or mix 1 part guano to 10 parts soil. One breeding pair produces approximately 10-15 kg of guano per year.
...
- Solar compass (sun position relative to internal clock)
- Olfactory mapping (smelling air currents from different directions)
- Visual landmark recognition (for familiar areas)
...
- **Canker (trichomoniasis)**: Protozoan infection of the throat and crop, common in squab. Yellow cheesy growths in the mouth interfere with feeding. Treat with metronidazole. Prevent by keeping water sources clean.
- **Coccidiosis**: Intestinal protozoan parasite. More common in damp lofts. Symptoms: weight loss, diarrhea. Treat with amprolium. Prevent with dry, clean loft conditions.
- **Respiratory infections**: Mycoplasma and chlamydia (ornithosis) cause respiratory distress. Good ventilation is preventive. Treatable with tetracycline-class antibiotics.
- **External parasites**: Pigeon lice, mites, and pigeon flies. Regular dusting with diatomaceous earth or pyrethrin-based powder. Keep nest boxes clean.
...
**Handling**:
Pigeons are docile and easily hand-tamed. Catch by reaching over the back and grasping both wings together, or gently encircle the body with one hand. Never grasp by the tail (feathers pull out easily) or by one wing. Squab do not struggle when handled.
