...
**Lime (CaO/Ca(OH)₂, pH 12-13)**: Liming operations use 6-10% calcium hydroxide on hide weight, producing slurries at pH 12.4. Contact with skin causes chemical burns within 30 seconds; eye contact causes corneal damage in 10 seconds. Lime dust (CaO particles <10 μm) is a severe respiratory irritant — inhaling 10-20 mg/m³ causes coughing and bronchial inflammation. Enclose lime mixing operations. Wear chemical splash goggles (not safety glasses — goggles seal around the eye), nitrile gloves (0.5 mm minimum thickness), and a P100 respirator during lime handling. Install eye wash stations within 10 seconds travel time from all lime-handling areas — flush eyes for 15 minutes minimum if exposed. Add lime to water (never water to lime — the exothermic reaction reaches 100°C and spatters).

**Hydrogen sulfide (H₂S) from dehairing**: Sodium sulfide (Na₂S) used at 1.5-3.0% on hide weight generates H₂S gas when the pH drops below 9. H₂S is immediately dangerous to life at 100 ppm, fatal at 300-500 ppm. It deadens the sense of smell at low concentrations — higher concentrations paradoxically become harder to detect by smell. Maintain dehairing baths at pH >9 at all times. Ventilate the dehairing area with forced air exchange (minimum 6 air changes per hour). Install electrochemical H₂S detectors with audible alarms set at 10 ppm (OSHA 8-hour TWA). Emergency procedure: evacuate the area, ventilate for 30 minutes minimum, re-enter only with self-contained breathing apparatus (SCBA). Never add acid to sulfide solutions — this releases massive quantities of H₂S instantly.

**Chromium compounds**: Basic chromium(III) sulfate (Cr(OH)SO₄) used in chrome tanning is relatively low toxicity (LD₅₀ oral rat >5,000 mg/kg), but oxidizes to chromium(VI) under alkaline, oxidizing conditions. Cr(VI) is a confirmed human carcinogen (IARC Group 1 — lung cancer via inhalation), causes skin ulcers and allergic dermatitis at 0.5-5.0 mg/cm² skin contact, and is highly mobile in groundwater. Chrome dust and mist from drum operations are respiratory irritants. Wear nitrile gloves, PVC apron, and splash-proof safety goggles when handling chrome tanning salts. Use local exhaust ventilation at drum openings. Wash hands before eating or smoking — chrome salts persist on skin. Effluent Cr(VI) limit: 0.05 mg/L (US EPA). Recover chrome from spent liquor by precipitation with NaOH to pH 8-9, filtering Cr(OH)₃ sludge, and redissolving in H₂SO₄ for reuse (60-80% recovery rate).

**Sodium sulfide (Na₂S)**: A strong reducing agent that dissolves keratin (hair protein). Skin contact causes alkali burns (pH 12-13 in solution). Ingestion of 10-15 g is lethal. Store in sealed containers away from acids and moisture. Spills generate H₂S — wet spills must be contained and neutralized with sodium hypochlorite (bleach) at a 3:1 ratio before cleanup.

**Splitting and shaving machines**: Band-knife splitting machines operate with a continuous blade moving at 5-15 m/s. The blade is exposed along a 300-500 mm cutting width. Contact with the moving blade causes deep lacerations to fingers and hands in <0.1 seconds. Two-hand trip controls (both hands on palm buttons to activate the feed) are mandatory. Blade guards must cover the full width except at the point of hide contact. Shaving machines use rotating helical blades at 500-1,500 RPM — never reach into the drum to clear jams while the machine is running. Lock-out/tag-out before any maintenance.

**Thermal hazards**: Beeswax melts at 62-64°C and flash-ignites at ~210°C — use double boilers, never direct heat. Drying ovens at 50-60°C for leather can cause contact burns. Case-hardened leather is baked at 120-150°C — oven surfaces are burn hazards. Embossing presses operate at 60-80°C and 100-200 bar — the heated plates cause contact burns and the pressure can amputate fingers. Gold tooling tools are heated to 120-150°C — handle only by the wooden shaft.

**Tannery wastewater**: Effluent contains BOD 2,000-8,000 mg/L, sulfides 50-300 mg/L, chromium 50-500 mg/L, and pH 8-12. Direct discharge kills aquatic life. Treat through sulfide oxidation, chrome precipitation, coagulation, and biological treatment before discharge. Sludge from chrome tanning operations is hazardous waste — do not compost or land-apply without chromium stabilization.
