...
|---------|---------------|----------|
| Madder dye bath produces dull brown instead of red | Extraction temperature exceeded 85°C, degrading alizarin; roots harvested in spring instead of autumn | Simmer roots at 70-80°C maximum (never boil); harvest roots in autumn (September-November) after 2-3 years' growth when alizarin concentration peaks at the top-growth die-back stage |
| Indigo fermentation vat produces no blue pigment | Temperature below 25°C or above 50°C, killing bacteria; insufficient alkalinity (pH below 9) | Maintain fermentation at 25-30°C for woad (12-15 days); add wood ash lye to achieve pH 9-10; fresh leaves required — dried leaves lose indican content rapidly |
| Weld dye produces pale yellow instead of clear bright yellow | Harvested after seed set rather than at flowering peak; insufficient plant material used (below 50% WOF for dried) | Harvest aerial parts at full flower (June-July) when luteolin concentration peaks; use 50-100% WOF for dried material or 200% WOF for fresh; apply alum mordant (15-20% WOF) for brightest yellow |
| Dye color washes out after 2-3 launderings | Mordant skipped or insufficient; cellulose fiber not pre-mordanted with tannin before alum | For cellulose fibers (cotton, linen): apply tannin pre-mordant (oak galls or sumac) at 10% WOF, then alum at 15-20% WOF; for protein fibers (wool, silk): alum at 15-20% WOF before dyeing |
| Woad extraction yield extremely low (less than 1 g indigo per kg leaves) | Leaves harvested after flowering when glucosinolate levels drop; insufficient beating/oxidation time | Harvest first-year rosette leaves before flowering (June-September); beat fermented liquor vigorously with paddles for 15-30 minutes; allow 2-4 hours settling time; woad naturally yields only 0.1-0.2% — use true indigo (*Indigofera*) if available for 5-10x higher yield |
| Iron mordant causes wool to become brittle and blackened over months | Iron overdose (above 5-10% WOF on protein fibers); iron catalyzes oxidative fiber degradation | Limit iron sulfate to 5-10% WOF on protein fibers; use iron only for color shifting (yellows→olive, pinks→purple), not as primary mordant; avoid iron on fine wool or silk — the damage is cumulative and irreversible |
| Walnut hull dye produces tan instead of rich brown on cotton | Walnut juglone bonds directly to protein fibers but not to cellulose without assistance; concentration too low | Use 30-60% WOF (weight of fiber) for deep brown; apply alum mordant (15-20% WOF) to cotton before dyeing to deepen color; iron mordant after dyeing shifts to near-black |
| Copper sulfate mordant handling causes skin irritation | Copper sulfate is toxic (vomiting at 100 mg dose); concentrated solutions irritate skin and eyes | Handle with nitrile gloves; dissolve in hot water in ventilated area; store blue crystals in labeled containers away from food; never pour copper-laden dye baths into waterways (toxic to aquatic life at <1 mg/L) |
| Coreopsis dye fading rapidly under UV exposure (lightfastness only 4-5) | Coreopsis has moderate lightfastness inherent to the compound; no mordant can fully compensate | Accept coreopsis as a moderately fast dye (rating 4-5 on 8-point scale); for permanent orange, use madder at low concentration with tin mordant; reserve coreopsis for items not exposed to prolonged sunlight |
| Safflower pink dye fading within months (lightfastness 2-3) | Safflower carthamin has inherently poor lightfastness (2-3 on 8-point scale); not suitable for permanent color | Accept that safflower pink is a temporary color; for permanent pink-red, use madder (*Rubia tinctorum*) with alum mordant (lightfastness 6-7); safflower is better used for its yellow dye (water-soluble fraction) before the pink extraction |
