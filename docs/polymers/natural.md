...
**Latex composition** (Hevea latex, typical):
- 30-40% rubber hydrocarbon (cis-1,4-polyisoprene) — the useful polymer
- 55-65% water — the continuous phase of the emulsion
- 2-5% proteins — natural stabilizers (also cause latex allergies)
...
- **Timing**: Cut early morning (4-7 AM) when latex flow is highest. Turgor pressure in the tree is highest before dawn; flow declines through the day as the tree loses water.
- **Collection**: Attach a small cup or coconut shell at the lower end of the cut to collect dripping latex. A typical cut yields latex for 2-4 hours before the wound begins to close.
- **Yield**: 20-50 g dry rubber per tree per tapping. A well-managed plantation tree produces 2-5 kg dry rubber per year.
...
3. **[Sheet making](../glossary/sheet-making.md)** — Press coagulum through a series of rollers (sheeting mill) to remove water and form uniform sheets ~3 mm thick. The ribbed pattern on rollers increases surface area for drying.
4. **[Drying](../glossary/drying.md)** — Hang sheets in a smokehouse at 40-60°C for 2-4 weeks. Smoke contains creosote compounds that act as natural preservatives, preventing mold. Product: ribbed smoked sheet (RSS), graded RSS 1-5 by visual quality.
5. **[Mastication](../glossary/mastication.md)** — pass through two-roll mill or internal mixer to soften and reduce molecular weight; mechanical shearing at 40-80°C. This makes the rubber plastic enough to accept compounding ingredients.
6. **[Compounding](../glossary/compounding.md)** — blend on mill or in Banbury mixer with:
...
**Chemistry**: Sulfur forms cross-links (polysulfide bridges) between adjacent polyisoprene chains. These cross-links transform the rubber from a thermoplastic (flows when hot) to an elastomer (elastic recovery after deformation). More sulfur = more cross-links = harder, less elastic rubber.

**Cure control**:
- **Undercured**: Soft, tacky surface, poor elastic recovery, low strength. Remedy: increase cure time or temperature.
- **Correctly cured**: Good elastic recovery, tensile strength 17-28 MPa, elongation at break 400-650%.
- **Overcured**: Hard, brittle, rough fracture surface. Sulfur continues cross-linking past optimum → degraded properties. Remedy: decrease cure time.
- **Simple test**: Cut a sample strip and stretch it. Good cure springs back to original length. Undercured rubber stays stretched. Overcured rubber snaps or cracks.
