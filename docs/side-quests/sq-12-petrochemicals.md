...
**Simple distillation** (batch still, Phase 2-3):
...
**Fractional distillation column** (continuous, Phase 5+):
...
- **Applications**: Acetone — solvent for resins, fats, plastics; key ingredient in nitrocellulose dope (SQ 13 aircraft). n-Butanol — solvent, feedstock for butyl rubber and esters.
