...
> **Enables**: [`energy.electric-furnaces.electrode-manufacturing`](./electric-furnaces.electrode-manufacturing.md),
> [`glass.basic.float-glass`](../glass/basic.float-glass.md),
> [`machine-tools.joining.diffusion-bonding`](../machine-tools/joining.diffusion-bonding.md),
> [`metals.powder-metallurgy`](../metals/powder-metallurgy.md),
> [`silicon.mg-si-production`](../silicon/mg-si-production.md)
...
|---------|---------------|----------|
| EAF electrode consumption exceeding 8 kg/tonne of steel | Oxidation of graphite electrodes at the arc tip running too long or too hot; or electrode joints (threaded nipples) leaking and arcing at the 1.5–2.5 m segment connections | Reduce arc length to 10–50 mm range via automatic impedance control. Tighten electrode nipple joints to full engagement — a loose joint arcs internally, burning the thread. Verify water-cooled roof panels are flowing at 20–40 L/min to reduce ambient temperature around electrodes |
| EAF refractory lining failing before 500 heats | Slag chemistry mismatch: basic MgO lining (300–500 mm thickness) attacked by acidic slag from high-silica charge; or excessive oxygen lancing erodes sidewall | Match lining to slag chemistry: basic MgO for lime-rich basic slag, SiO₂ for acidic slag, Al₂O₃ for neutral. Control oxygen lance angle and duration during refining. Monitor lining thickness with laser measurement — plan relining before wall thins below 150 mm |
| EAF failing to reach tap temperature (1600–1650°C) within 40 min melt period | Insufficient power input or excessive scrap charge weight for connected MW rating; specific energy requirement of 300–600 kWh/tonne not being met | Verify furnace transformer tap changer is on correct setting (100–800 V secondary, 20–100 kA). Weigh charge accurately — do not exceed design tonnage. Check electrode regulation system is maintaining full-power impedance setpoint. Preheat scrap with off-gas heat recovery to reduce melt energy by 10–20% |
| SAF charge solidification during power interruption | Continuous 24/7 operation interrupted; molten charge at 1800–2100°C (silicon production) solidifies in furnace, cracking the carbon lining and blocking tapholes | Install uninterruptible power supply or backup generator with automatic transfer switch (transfer time <10 seconds). Never shut down SAF without controlled drain of molten product through taphole. If solidification occurs, controlled reheating at low power over 24–48 hours may recover — do not apply full power to frozen charge |
| Resistance furnace heating element failure before rated life | Element operating above material limit: Nichrome at >1150°C, Kanthal at >1400°C, or MoSi₂ at >1800°C; or graphite element oxidizing in air above ~500°C | Match element material to required furnace temperature. For graphite elements, maintain reducing/inert atmosphere (N₂ or Ar). Verify PID controller and thermocouple are functioning — a failed thermocouple causes runaway heating. For SiC elements, increase applied voltage periodically as resistance rises with aging to maintain power output |
| Furnace power factor below 0.65, causing grid voltage flicker | Arc furnace drawing highly variable reactive current; poor power factor (0.65–0.85 range) causes voltage swings on the supply that flicker lights and disrupt other equipment | Install capacitor banks sized to correct power factor to >0.90 at typical operating point. For severe flicker, install static VAR compensator (SVC). Verify furnace transformer tap position is optimized for current charge state (higher voltage during bore-down, lower during flat-bath refining) |
| Induction furnace coil overheating despite water cooling | Scale buildup inside water-cooled copper coil reducing flow; or coil insulation breakdown causing eddy current losses in the coil itself at 200–800 kW/tonne power density | Back-flush coil with descaling solution; install water treatment (softened water, <50 ppm hardness). Verify water flow rate meets design (typically 10–30 L/min per coil section). Check coil insulation resistance — ground fault indicates cracked or worn insulation requiring re-wrapping |
| Submerged arc furnace electrode breakage | Søderberg self-baking electrode paste not fully cured before reaching the arc zone; soft paste column shears under its own weight at 600–1500 mm diameter | Verify paste baking rate matches electrode consumption rate — adjust paste composition (calcined anthracite + coal tar pitch) or furnace operating profile. Monitor electrode slip and casing temperature gradient. For prebaked electrodes, check that threaded joints are properly torqued and aligned before lowering |
| Resistance furnace unable to maintain ±5°C temperature uniformity | Heating elements aged unevenly (SiC resistance changes with use); or thermocouple drifted from calibration, reading 10–20°C different from actual chamber temperature | Replace aged SiC elements as a matched set to restore uniform resistance. Recalibrate thermocouple against a certified reference (Type K or S thermocouple for >1000°C). Verify PID tuning — oscillating control causes ±10–20°C swings. Check that furnace door seal is intact; air leaks cause localized cold spots |
| EAF water-cooled panel leak detected | Pipe coil (50–80 mm diameter copper or steel tube) welded to backing plate has developed a crack from thermal cycling at 20–40 L/min flow; water contacting molten steel causes steam explosion risk | Immediately reduce furnace power and do not tap until panel is repaired. Isolate leaking panel from cooling circuit. Weld repair the crack from outside (backing plate side) — never weld on the furnace-side surface while hot. Inspect all panels monthly for corrosion, erosion, and weld cracking; replace panels showing wall thinning >30% |
