...
**[Typical ECF sequence](../glossary/typical-ecf-sequence.html)** (D₀EopD₁EPD₂): (1) **[D₀](../glossary/d-chemistry.html)** — ClO₂ at pH 2.5-3.5, 50-70°C, 30-60 min. Oxidizes lignin (electron transfer — ClO₂ reduced to ClO₂⁻) but does not chlorinate (unlike Cl₂, which forms chlorinated organics including dioxins). (2) **[Eop](../glossary/eop.html)** — NaOH extraction with oxygen and hydrogen peroxide reinforcement at 70-80°C. Dissolves oxidized lignin fragments. O₂ and H₂O₂ provide additional delignification without chlorine. (3) **[D₁](../glossary/d-chemistry-2.html)** — second ClO₂ stage, higher temperature (70-75°C). Further bleaching. (4) **[EP](../glossary/ep.html)** — alkaline extraction with H₂O₂. (5) **[D₂](../glossary/d-chemistry-3.html)** — final ClO₂ stage, targets >88% ISO brightness.
...
**[Modern ECF sequence (D₀EopD₁EPD₂)](../glossary/modern-ecf-sequence-deopdepd.html)** replaces the C stage with chlorine dioxide. ClO₂ performs selective oxidation rather than chlorination of lignin, reducing chlorinated organic formation by 90-95%. Typical chemical doses: ClO₂ at 0.8-1.5% active chlorine equivalent per D stage, NaOH at 0.8-1.5% per E stage, H₂O₂ at 0.5-1.0% in reinforced extraction stages.
