# Side Quests: Parallel Development Tracks

The core tech tree (Phases 1–9) traces the critical path to semiconductors, but real-world success requires parallel development in supporting infrastructure. These "side quests" prevent single points of failure, accelerate progress, and make the entire multi-generational effort sustainable.

## Why Side Quests Matter

The main sequence is strong on technical dependencies but under-emphasizes:
- Human capital and knowledge continuity
- Logistics and scale
- Supporting materials ecosystems
- Safety, quality, and metrology depth
- Feedback loops that accelerate progress
- Long-term energy sustainability

## All Side Quests

| # | Name | Starts | Key Benefit |
|---|------|--------|-------------|
| [SQ 1](sq-01-knowledge-preservation.md) | Knowledge Preservation &amp; Education | Phase 1 | Prevents knowledge loss across generations |
| [SQ 2](sq-02-measurement-metrology.md) | Measurement, Timekeeping &amp; Metrology | Phase 1–3 | Enables interchangeable parts &amp; repeatable processes |
| [SQ 3](sq-03-transport-logistics.md) | Transportation, Logistics &amp; Communication | Phase 2–4 | Moves materials, people, information efficiently |
| [SQ 4](sq-04-mechanical-computing.md) | Mechanical Computing &amp; Automation | Phase 3 | Speeds calculations for design &amp; process control |
| [SQ 5](sq-05-public-health.md) | Public Health &amp; Medicine | Phase 1+ | Keeps skilled workers alive and productive |
...
| [SQ 14](sq-14-polymers-composites.md) | Polymers & Composites | Phase 5+ | Process-level polymer synthesis, elastomers, thermosets, thermoplastics, composites |
...
10. **Materials science**: [SQ 14](sq-14-polymers-composites.md) (Polymers & Composites) — engineering materials from chemical feedstocks
