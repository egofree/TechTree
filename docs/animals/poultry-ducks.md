...
**Khaki Campbell**:
The premier egg-laying duck, rivaling the best chicken layers. Khaki-colored plumage, 1.5-2.0 kg adults. Egg production: 250-340 eggs per year (white-shelled, 65-75 g each) — making them one of the most productive egg-laying birds of any species. Feed consumption: 120-150 g per day. Hardy, active foragers that perform best with access to water for swimming and foraging. Good temperaments, relatively quiet. Not a meat bird — the small carcass yields only 1.0-1.2 kg dressed weight.

**Muscovy**:
Not closely related to mallard-derived ducks — a separate species with distinct characteristics. Native to tropical America. Adults are large: drakes 5-7 kg, ducks 2.5-3.5 kg. Distinctive red caruncles (fleshy growths) on the face. Muscovies are strong fliers (clip flight feathers to contain) and prefer to roost in trees or on elevated perches, unlike other ducks. Meat is leaner and stronger-flavored than Pekin (sometimes described as beef-like). Egg production: 80-120 eggs per year (60-70 g each). Unique among ducks: Muscovies go broody readily and make excellent mothers. Incubation period: 35 days (vs 28 days for mallard-derived ducks). Muscovies are quiet — males hiss rather than quack. They also eat large quantities of flies, mosquitoes, and their larvae, providing insect control around livestock areas.

**Indian Runner**:
Upright, penguin-like posture allowing remarkable walking speed. Originally from the East Indies, bred as egg layers that could be herded to rice paddies by day and penned at night. 1.5-2.0 kg adults. Egg production: 200-280 eggs per year. Excellent foragers that cover large areas consuming insects, snails, and weed seeds. Unusually active and mobile for a duck — they walk rather than waddle. Available in various colors (fawn, white, black, chocolate).

**Breed comparison**:
| Feature | Pekin | Khaki Campbell | Muscovy | Indian Runner |
|---------|-------|----------------|---------|---------------|
| Primary use | Meat | Eggs | Meat/pest control | Eggs/foraging |
| Adult weight | 3.5-5 kg | 1.5-2 kg | 2.5-7 kg | 1.5-2 kg |
| Eggs/year | 140-200 | 250-340 | 80-120 | 200-280 |
| Egg weight | 75-85 g | 65-75 g | 60-70 g | 65-75 g |
| Broodiness | Poor | Poor | Good | Poor |
| Foraging ability | Moderate | Good | Excellent | Excellent |
...
**Fencing**:
Ducks do not fly (except Muscovies, which require wing clipping or covered runs) and respect low fencing. A 60-90 cm fence contains most breeds. Bury fencing 15-20 cm or use an apron to prevent digging predators. Electric fencing at 10-15 cm above ground deters ground predators effectively. Ducks can be contained with portable electric poultry netting, making rotational grazing straightforward.
...
**Swimming water**:
Swimming water is beneficial but not strictly required for survival. Ducks with swimming access are cleaner, healthier, and more productive. A child's wading pool, stock tank, or natural pond suffices. Swimming water must be kept clean — ducks defecate in water rapidly (one duck produces approximately 0.15 kg of manure per day). Change or filter water frequently. A pond with 10+ ducks requires biological filtration or flowing water to maintain quality.
...
**Foraging**:
Ducks are superior foragers to chickens in wet environments. They consume slugs, snails, aquatic insect larvae, tadpoles, small fish, duckweed, and aquatic plants. A duck on good pasture with water access may obtain 30-50% of its dietary needs from foraging. Ducks are particularly effective at controlling slug and snail populations — a significant advantage in damp climates where these pests devastate vegetable crops.

**Duckweed cultivation**:
Duckweed (*Lemna* spp.) is one of the fastest-growing aquatic plants, doubling its biomass every 2-3 days under optimal conditions. It contains 35-43% crude protein (dry weight basis) — one of the highest protein contents of any plant. A small pond or tank of duckweed can supply a significant portion of duck feed. Harvest by skimming the surface. Production: 10-30 tonnes dry matter per hectare per year. Ducks consume duckweed fresh directly from the water surface.
...
**Production cycle**:
Khaki Campbells begin laying at 16-20 weeks and produce 250-340 eggs in the first year, declining 10-15% per year thereafter. Pekins lay 140-200 eggs per year. Ducks lay eggs in the early morning (typically before 8:00 AM) — collect eggs by mid-morning to prevent predation and dirty eggs. Ducks often lay eggs on the ground in secluded corners rather than in nest boxes, though providing low nest boxes (15-20 cm entrance, ground-level) encourages cleaner egg-laying.
...
**Processing**:
Similar to chickens: dispatch, bleed for 2-3 minutes, scald at 55-60°C for 60-90 seconds (duck feathers are more water-resistant than chicken feathers and require longer scalding), pluck, eviscerate. Ducks are more difficult to pluck cleanly than chickens — the downy underfeathers resist removal. Wax dipping after initial plucking removes remaining down: dip the plucked carcass in molten wax (60-70°C), cool to harden, then peel off the wax with embedded down feathers. Save rendered duck fat — it is a premium cooking fat with a high smoke point and rich flavor.
...
Mallard-derived duck eggs: 37.2-37.5°C, 55-65% humidity for first 25 days. Turn 3-5 times daily. Increase humidity to 70-75% for the final 3 days (lockdown). Incubation period: 28 days. Muscovy eggs: same temperature, 28 days of turning, then lockdown — incubation period is 35 days (one of the longest for domestic poultry). Hatch rate: 70-85% from fertile eggs.
...
**Common issues**:
- **Botulism**: Ducks foraging in stagnant water or decaying vegetation are susceptible to *Clostridium botulinum* type C toxin (not the human type A). Causes progressive paralysis ("limberneck"). Prevent by keeping water clean and removing decaying organic matter from duck areas. Treat with type C antitoxin if available.
- **Aspergillosis**: Fungal respiratory infection from moldy bedding or feed. Ducks are more susceptible than chickens due to their foraging habits. Maintain dry bedding, ensure ventilation, and discard moldy feed.
- **Bumblefoot**: Infection of the foot pad from abrasions on rough surfaces. More common in heavy breeds (Pekin, Muscovy). Provide smooth, clean flooring.
- **Angel wing**: Twisted wing joint in growing ducks caused by excessive protein/calorie intake during rapid growth phase. Reduce protein to 15-16% and limit feed if wing feathers start curling outward. More common in fast-growing Pekins.
- **Predation**: Ducks on the ground are vulnerable at night. Secure them in a predator-proof shelter from dusk to dawn.
...
**Water hygiene**:
Standing water in duck areas becomes contaminated with *Salmonella*, *E. coli*, and other pathogens rapidly. Do not allow children to play in duck ponds. Wash hands after handling ducks, eggs, or equipment. Ducks should not share water sources with human drinking water supplies.
