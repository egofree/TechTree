...
- **Host tree management**: Plant host trees (or use existing forest trees). Maintain spacing of 5-8 m between trees (150-400 trees per hectare depending on species and management intensity). Prune lower branches to improve access and air circulation — good airflow reduces fungal disease and allows lac insects to colonize branches effectively. *Butea monosperma* can be grown from seed or root cuttings; trees reach lac-producing age in 5-7 years. *Schleichera oleosa* is slower to establish but produces higher-quality lac.
