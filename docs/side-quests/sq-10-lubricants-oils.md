# SQ 10: Lubricants, Oils & Fluid Mechanics

**Starts**: Phase 1
**Priority**: Critical — without lubrication, every moving part seizes.
...
- **Oil mist lubrication** (Phase 4+): Atomize oil with compressed air, pipe mist to bearing. Continuous fine lubrication. Excellent for high-speed spindle bearings. Requires clean, dry compressed air.
...
**Fluid types**:
- **Vegetable oil-based**: Rapeseed or castor oil. Biodegradable, good lubricity. Limited temperature range (thickens when cold, thins when hot). Oxidizes over time. For Phase 2-3 hydraulic presses.
- **Mineral oil-based** (Phase 5+): Refined petroleum oil (see SQ 12 — distillation). ISO VG 32 or 46 most common. Add anti-wear agents (ZDDP), antioxidants, rust inhibitors, anti-foam agents. Operating temperature range -10°C to +70°C. Most common hydraulic fluid.
...
- **Silicone vacuum oil** (Phase 6+): Polydimethylsiloxane (PDMS) — from silicon + methyl chloride chemistry. Very low vapor pressure (~10⁻⁶ Pa at 25°C). Chemically inert. For diffusion pumps (see Phase 6) — achieves ultimate vacuum ~10⁻⁶ to 10⁻⁸ Pa.
- **Synthetic hydrocarbon oil** (Phase 5+): Polyalphaolefin (PAO). Low vapor pressure, excellent lubricity, wide temperature range. For high-performance mechanical pumps.
...
**Cleanroom-compatible lubricants** (Phase 8):
...
- Specialty perfluoropolyether (PFPE) greases — extremely inert, wide temperature range, ultra-low vapor pressure. Synthesized from HF + olefins under controlled conditions (Phase 8+ chemistry).

## Integration Points

| Phase | Contribution |
|-------|-------------|
| Phase 1 | Animal fat collection and rendering, basic axle grease for carts and simple machines |
| Phase 2 | Tallow-lubricated bearings for treadle lathes and bellows, vegetable oil extraction |
| Phase 3 | Cutting fluids and machine oils for precision machine tools, grease production |
| Phase 4 | Cylinder oils for steam engines, high-temperature bearing lubrication, hydraulic fluid for presses |
| Phase 5 | Chemical processing of oils, soap thickeners for grease, mineral oil refining, synthetic additives |
| Phase 6 | Low-vapor-pressure oils for vacuum pump seals and diffusion pumps |
| Phase 7 | Ultraclean lubricants for crystal pullers and wafer handling equipment |
| Phase 8 | Cleanroom-compatible lubricants and hydraulic fluids for fab equipment, PFPE greases |
...
- Vacuum-compatible oils for Phase 6+ pump systems (mineral → silicone)
