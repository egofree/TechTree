...
- **High energy storage**: Power converters store energy in capacitors (E = ½CV²) and inductors (E = ½LI²). A 4700 μF capacitor charged to 400 V stores 376 J, enough to cause severe burns, cardiac arrest, or arc flash. For comparison, a defibrillator delivers 150-360 J. Always discharge capacitors through a bleeder resistor (100-1000 Ω, rated for peak power: P_peak = V²/R = 400²/100 = 1600 W for a 100 Ω resistor at 400 V; use a 5-25 W wirewound resistor with appropriate surge rating). Wait 5× the RC time constant for full discharge: for 4700 μF through 100 Ω, τ = 0.47 s, wait 2.35 seconds minimum. Never short charged capacitors with a screwdriver. At 400 V, the instantaneous short-circuit current exceeds 10 kA, producing an arc at >10,000°C that vaporizes the screwdriver tip and sprays molten copper and steel.
- **High voltage**: Off-line converters (rectified mains: 170 V DC for 120 V AC, 340 V DC for 240 V AC) present lethal shock hazard. Current as low as 30 mA through the chest causes ventricular fibrillation. At 340 V DC, dry skin resistance (~2 kΩ hand-to-hand) allows 170 mA, well above the fibrillation threshold. Creepage and clearance requirements: 3-6 mm for 240 V mains per IEC 60950. All high-voltage sections must be insulated and marked with danger symbols. Service personnel must use isolated tools and insulating mats (IEC 61111 Class 0, rated to 1000 V). GFCI protection on test bench circuits trips at 5 mA imbalance in <25 ms.
- **High current**: Low-voltage, high-current converters (e.g., 12 V at 100 A = 1.2 kW) can cause severe burns from heated conductors. A 12 V source feeding a short circuit through 0.01 Ω bus bar resistance delivers 1200 A instantaneously, generating P = I²R = 14,400 W in the fault. This melts copper (melting point 1085°C) at the constriction point within milliseconds. A sustained arc at >1000 A peak produces blast pressure and molten metal ejection. Use appropriately rated fuses or circuit breakers on every output (interrupting rating >10 kA at the supply voltage). Wire gauge must match current: minimum 6 AWG (13.3 mm², rated 55-75 A depending on insulation) for 100 A circuits; use bus bars for >200 A.
- **Thermal hazards**: Power semiconductor heatsinks may reach 60-100°C during normal operation. MOSFET/IGBT junction temperatures operate at 100-150°C. Contact with 70°C for 1 second produces a second-degree burn (Stoll curve: skin damage threshold is 48°C for prolonged contact, 70°C for <1 second). Use warning labels. Enclose hot surfaces in vented covers. Allow 10 minutes for cooling after power-off before handling.
- **Arc flash**: In high-voltage inverters (>480 V), arc flash from short circuits can reach 20,000°C. Incident energy calculations per IEEE 1584 determine required PPE. For a 480 V drive with 30 kA available fault current and a 0.2 second clearing time at 0.6 m working distance: incident energy ≈ 8-15 cal/cm², requiring arc-rated clothing (minimum 8 cal/cm² HRC Level 2), face shield with arc-rated lens, hearing protection, and voltage-rated gloves.
